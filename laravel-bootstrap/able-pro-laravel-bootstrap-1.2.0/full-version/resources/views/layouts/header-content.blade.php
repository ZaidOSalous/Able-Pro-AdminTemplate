          ...
          <div class="profile-notification-scroll position-relative" style="max-height: calc(100vh - 225px)">
            ...
            <a href="#" class="dropdown-item">
              ...
              <div class="user-group">
                <img src="/build/images/user/avatar-1.jpg" alt="user-image" class="avtar" />
            ...
            <div class="card border-0 shadow-none drp-upgrade-card mb-0" style="background-image: url(/build/images/layout/img-profile-card.jpg)">
              <div class="card-body">
                <div class="user-group">
                  <img src="/build/images/user/avatar-1.jpg" alt="user-image" class="avtar" />
                  <img src="/build/images/user/avatar-2.jpg" alt="user-image" class="avtar" />
                  <img src="/build/images/user/avatar-3.jpg" alt="user-image" class="avtar" />
                  <img src="/build/images/user/avatar-4.jpg" alt="user-image" class="avtar" />
                  <img src="/build/images/user/avatar-5.jpg" alt="user-image" class="avtar" />
