...
function layout_change(layout) {
  ...
  if (layout === 'dark') {
    ...
    updateLogo('.pc-sidebar .m-header .logo-lg', '/static/assets/images/logo-white.svg');
    updateLogo('.navbar-brand .logo-lg', '/static/assets/images/logo-white.svg');
    updateLogo('.auth-main.v1 .auth-sidefooter img', '/static/assets/images/logo-white.svg');
    updateLogo('.footer-top .footer-logo', '/static/assets/images/logo-white.svg');
    ...
    updateLogo('.pc-sidebar .m-header .logo-lg', '/static/assets/images/logo-dark.svg');
    updateLogo('.navbar-brand .logo-lg', '/static/assets/images/logo-dark.svg');
    updateLogo('.auth-main.v1 .auth-sidefooter img', '/static/assets/images/logo-dark.svg');
    updateLogo('.footer-top .footer-logo', '/static/assets/images/logo-dark.svg');
