...
<div class="auth-main">
  <div class="auth-wrapper v2">
    ...
    <div class="auth-form">
      <div class="card my-5">
        <div class="card-body">
          <a href="/pages/forgot-password-v2"><img src="../assets/images/logo-dark.svg" class="mb-4 img-fluid" alt="img" /></a>
          <div class="d-flex justify-content-between align-items-end mb-4">
            <h3 class="mb-0"><b>Forgot Password</b></h3>
            <a href="/pages/login-v2" class="link-primary">Back to Login</a>
          </div>
          <div class="mb-3">
