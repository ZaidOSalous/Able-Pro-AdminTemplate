<script>
  ...
  import Swal from 'sweetalert2/dist/sweetalert2.all.min.js?client';
  ...
  <div class="auth-wrapper v3">
    <div class="auth-form">
      <div class="auth-header row">
        <div class="col my-1">
          <a href="/pages/login-v3"><img src="/assets/images/logo-dark.svg" alt="img" /></a>
        </div>
        <div class="col-auto my-1">
          <h5 class="m-0 text-muted f-w-500">
            Step <b class="h5" id="auth-active-slide">1</b> to 5
          </h5>
        </div>
      </div>
      <div class="card my-5">
            ...
            <div class="tab-pane show active" id="auth-1" role="tabpanel" aria-labelledby="auth-tab-1">
              <div class="text-center">
                ...
                <div class="d-grid my-3">
                  ...
                  >
                    <img src="/assets/images/authentication/sms.svg" alt="img" />
            ...
            <div class="tab-pane" id="auth-5" role="tabpanel" aria-labelledby="auth-tab-5">
              ...
              <div class="d-grid">
                <button
                  ...
                  class="btn btn-primary auth-conf">Continue</button
                >
              </div>
            </div>
          </div>
      ...
      <div class="auth-footer">
        <p class="m-0 w-100 text-center">
          By signing up, you confirm to have read Able pro <a href="/pages/login-v3">Privacy Policy</a>
          and agree to the
          <a href="/pages/login-v3">Terms of Service</a>.
        </p>
      </div>
    </div>
        ...
        <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel">
          <div class="carousel-inner">
            <div class="carousel-item active">
              <img src="/assets/images/user/avatar-1.jpg" alt="img" class="user-avtar wid-50 rounded-circle mb-3" />
            ...
            <div class="carousel-item">
              <img src="/assets/images/user/avatar-2.jpg" alt="img" class="user-avtar wid-50 rounded-circle mb-3" />
              <h5 class="text-white mb-0">Allie Grater</h5>
              <p class="text-white text-opacity-50">@alliegrater</p>
              <div class="star f-20 my-4">
                <i class="fas fa-star text-warning"></i>
            ...
            <div class="carousel-item">
              <img src="/assets/images/user/avatar-3.jpg" alt="img" class="user-avtar wid-50 rounded-circle mb-3" />
              <h5 class="text-white mb-0">Allie Grater</h5>
              <p class="text-white text-opacity-50">@alliegrater</p>
              <div class="star f-20 my-4">
                <i class="fas fa-star text-warning"></i>
            ...
            <div class="carousel-item">
              <img src="/assets/images/user/avatar-4.jpg" alt="img" class="user-avtar wid-50 rounded-circle mb-3" />
              <h5 class="text-white mb-0">Allie Grater</h5>
              <p class="text-white text-opacity-50">@alliegrater</p>
              <div class="star f-20 my-4">
                <i class="fas fa-star text-warning"></i>
            ...
            <div class="carousel-item">
              <img src="/assets/images/user/avatar-5.jpg" alt="img" class="user-avtar wid-50 rounded-circle mb-3" />
              <h5 class="text-white mb-0">Allie Grater</h5>
              <p class="text-white text-opacity-50">@alliegrater</p>
              <div class="star f-20 my-4">
                <i class="fas fa-star text-warning"></i>
