<script>
  ...
  import { layout_change, layout_change_default } from '../../../stores/layoutStore';
  let simpleBar;
  let simpleBarProfile;

  onMount(async () => {
    const header = document.querySelector('.header-notification-scroll');
    const profile = document.querySelector('.profile-notification-scroll');
    if (header || profile) {
      const SimpleBarModule = await import('simplebar'); // Import the module
      const SimpleBar = SimpleBarModule.default;
      simpleBar = new SimpleBar(header);
      simpleBarProfile = new SimpleBar(profile);
    }
  });
    ...
    <div class="me-auto pc-mob-drp">
      <ul class="list-unstyled">
        ...
        <li class="pc-h-item pc-sidebar-popup">
          <a href="#!" class="pc-head-link ms-0" id="mobile-collapse" on:click|preventDefault={openSidebar}>
            <i class="ti ti-menu-2"></i>
          </a>
        </li>
      ...
      <ul class="list-unstyled">
        <li class="dropdown pc-h-item">
          ...
          <div class="dropdown-menu dropdown-menu-end pc-h-dropdown">
            <a href="#!" class="dropdown-item" on:click|preventDefault={() => layout_change('dark')}>
              <svg class="pc-icon">
                <use xlink:href="#custom-moon"></use>
              </svg>
              <span>Dark</span>
            </a>
            <a href="#!" class="dropdown-item" on:click|preventDefault={() => layout_change('light')}>
              <svg class="pc-icon">
                <use xlink:href="#custom-sun-1"></use>
              </svg>
              <span>Light</span>
            </a>
            <a href="#!" class="dropdown-item" on:click|preventDefault={() => layout_change_default()}>
              <svg class="pc-icon">
        ...
        <li class="dropdown pc-h-item header-user-profile">
          <a
            ...
            aria-expanded="false"
          >
            <img src="/assets/images/user/avatar-2.jpg" alt="" class="user-avtar" />
          </a>
            ...
            <div class="dropdown-body">
              <div class="profile-notification-scroll position-relative" style="max-height: calc(100vh - 225px)">
                <div class="d-flex mb-1">
                  <div class="flex-shrink-0">
                    <img src="/assets/images/user/avatar-2.jpg" alt="" class="user-avtar wid-35" />
                  </div>
                  <div class="flex-grow-1 ms-3">
                ...
                <a href="#!" class="dropdown-item">
                  ...
                  <div class="user-group">
                    <img src="/assets/images/user/avatar-1.jpg" alt="" class="avtar" />
                ...
                <div class="d-grid mb-3">
                  <button class="btn btn-primary">
                    <svg class="pc-icon me-2"> <use xlink:href="#custom-logout-1-outline"></use></svg>Logout
                  </button>
                </div>
                <div
                ...
                >
                  <div class="card-body">
                    <div class="user-group">
                      <img src="/assets/images/user/avatar-1.jpg" alt="" class="avtar" />
                      <img src="/assets/images/user/avatar-2.jpg" alt="" class="avtar" />
                      <img src="/assets/images/user/avatar-3.jpg" alt="" class="avtar" />
                      <img src="/assets/images/user/avatar-4.jpg" alt="" class="avtar" />
                      <img src="/assets/images/user/avatar-5.jpg" alt="" class="avtar" />
    ...
    <div class="card mb-3">
      <div class="card-body">
        ...
        <a href="https://1.envato.market/zNkqj6" target="_blank"
          ><img src="/assets/images/layout/img-announcement-2.png" alt="img" class="img-fluid" /></a
        >
      </div>
    </div>
