...
<svelte:head>
  <title>Mega Option | Able Pro Dashboard Template</title>
</svelte:head>
<title>Mega Option | Able Pro Dashboard Template</title>
<!-- [Meta] -->
...
<div class="pc-container">
  <div class="pc-content">
    <!-- [ breadcrumb ] start -->
    <Breadcrumb item="Forms" itemActive="Mega Option" />
    <!-- [ breadcrumb ] end -->
                        ...
                        <label class="form-check-label d-block" for="customCheckdef1">
                          <span>
                            <span class="h5 d-block"
                              ><strong class="float-end"><span class="badge bg-light-primary">Free</span></strong>Trial plan</span
                            >
