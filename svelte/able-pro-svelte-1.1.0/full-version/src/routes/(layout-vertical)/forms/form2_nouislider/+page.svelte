<script>
  ...
  import noUiSlider from 'nouislider?client';
  import wNumb from 'wnumb?client';
...
<div class="pc-container">
  <div class="pc-content">
    <!-- [ breadcrumb ] start -->
    <Breadcrumb item="Forms" itemActive="NoUiSlider" />
    <!-- [ breadcrumb ] end -->
            ...
            <form>
              ...
              <div class="row mb-5">
                ...
                <div class="col-lg-6 col-md-12 col-sm-12">
                  <div class="row align-items-center g-3">
                    ...
                    <div class="col-sm-6">
                      <div id="pc-no_ui_slider-4" class="pc-nouislider pc-no_ui_slider--handle-primary pc-no_ui_slider--connect-warning"
                      ></div>
                    </div>
                  </div>
                  <small class="form-text text-muted"
              ...
              <div class="row mb-5">
                ...
                <div class="col-lg-6 col-md-12 col-sm-12">
                  ...
                  <small class="form-text text-muted"
                    >If you want to disable the edges of a slider, the set event can be used to reset the value if a limit is passed.</small
                  >
                </div>
              </div>
