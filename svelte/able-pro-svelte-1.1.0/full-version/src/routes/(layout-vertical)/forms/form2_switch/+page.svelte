...
<svelte:head>
  <title>Switch | Able Pro Dashboard Template</title>
</svelte:head>
...
<div class="pc-container">
  <div class="pc-content">
    <!-- [ breadcrumb ] start -->
    <Breadcrumb item="Forms" itemActive="Switch" />
    <!-- [ breadcrumb ] end -->
      ...
      <div class="col-lg-6">
        <div class="card">
          ...
          <div class="card-body">
            <form>
              <div class="mb-3">
                <label class="mb-2">Small Switches</label>
              ...
              <div class="mb-3">
                <label class="mb-2">Large Switches</label>
              ...
              <div class="mb-3">
                <label class="mb-2">Color States</label>
