<script>
  ...
  import StarRating from 'star-rating.js?client';
  import Breadcrumb from '../../../../lib/Components/Layouts/Partials/Breadcrumb.svelte';
  import 'star-rating.js/dist/star-rating.min.css';
  import '$lib/assets/css/rating.css';
  let destroyed = false;
  let starratingPrebuilt, starrating, starratingOld, heartrating, star_rating_hide;

  onMount(() => {
    starratingPrebuilt = new StarRating('.star-rating-prebuilt', {
      prebuilt: true,
      maxStars: 5
    });
    heartrating = new StarRating('.heart-rating', {
      stars: (el, item, index) => {
        el.innerHTML =
    ...
    starrating = new StarRating('.star-rating', {
    ...
    star_rating_hide = new StarRating('.star-rating-hide', {
      stars: function (el, item, index) {
        el.innerHTML =
          '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><rect class="gl-star-full" width="19" height="19" x="2.5" y="2.5"/><polygon fill="#FFF" points="12 5.375 13.646 10.417 19 10.417 14.665 13.556 16.313 18.625 11.995 15.476 7.688 18.583 9.333 13.542 5 10.417 10.354 10.417"/></svg>';
      },
    ...
    starratingOld = new StarRating('.star-rating-old');
  });
...
<svelte:head>
  <title>Rating | Able Pro Dashboard Template</title>
</svelte:head>
<!-- [ Main Content ] start -->
<div class="pc-container">
  <div class="pc-content">
    <!-- [ breadcrumb ] start -->
    <Breadcrumb item="Forms" itemActive="Rating" />
    <!-- [ breadcrumb ] end -->
    ...
    <div class="row">
      ...
      <div class="col-md-10 col-xxl-9 mb-4">
            <h5>Rating</h5>
            <p class="text-muted">A zero-dependency ES6 module that transforms a SELECT with numerical-range values (i.e. 1-5) into a dynamic star rating element.</p>
            <div>
              <a class="btn btn-sm btn-light-dark rounded-pill px-2" role="button" target="_blank" href="https://pryley.github.io/star-rating.js/">
          ...
          <div class="card-body">
            <form>
                  ...
                  <span class="gl-star-rating">
                    ...
                    <span class="gl-star-rating--stars">
                      <span data-value="1" class=""
                        ><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="gl-emote" style="pointer-events: none">
              ...
              <div class="mb-3 row">
                ...
                <div class="col-lg-9 col-md-9 col-sm-12">
                  <select id="glsr-custom-options" class="star-rating-hide">
                    <option value="">Select a rating</option>
                  ...
                  <label for="glsr-custom-options" style="pointer-events: none;"
                    >Using the "data-options" attribute to hide the tooltip and prevent the control from being cleared</label
                  >
                </div>
              </div>
              <div class="mb-3 row align-items-center">
                ...
                <div class="col-lg-9 col-md-9 col-sm-12">
                  <button on:click={() => toggleRatings()} type="button" class="btn btn-primary toggle-star-rating"
                    >Toggle Star Rating</button
                  >
