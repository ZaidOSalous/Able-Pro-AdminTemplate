...
<svelte:head>
  <title>Wizard | Able Pro Dashboard Template</title>
</svelte:head>
<!-- [ Main Content ] start -->
<div class="pc-container">
  <div class="pc-content">
    <!-- [ breadcrumb ] start -->
    <Breadcrumb item="Forms" itemActive="Wizard" />
    <!-- [ breadcrumb ] end -->
        ...
        <div id="basicwizard" class="form-wizard row justify-content-center">
          <div class="col-sm-12 col-md-6 col-xxl-4 text-center">
            ...
            <p class="text-muted mb-4"
              >A group of people who collectively are responsible for all of the work necessary to produce working, validated assets.</p
            >
          </div>
          <div class="col-12">
            <div class="card">
                      ...
                      <div class="row mt-4">
                        <div class="col-sm-auto text-center">
                          <div class="position-relative me-3 d-inline-flex">
                            ...
                            <img src="/assets/images/application/img-prod-3.jpg" alt="img" class="wid-150 rounded img-fluid ms-2" />
                          </div>
                        </div>
                        <div class="col">
                          <div class="row">
