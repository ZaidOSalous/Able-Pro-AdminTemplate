<script>
  ...
  import Bouncer from 'formbouncerjs?client';
  onMount(() => {
...
<div class="pc-container">
  <div class="pc-content">
    <!-- [ breadcrumb ] start -->
    <Breadcrumb item="Forms" itemActive="Form Validation" />
    <!-- [ breadcrumb ] end -->
    ...
    <div class="row">
      ...
      <div class="col-md-10 col-xxl-9 mb-4">
            <h5>Bouncer</h5>
            <p class="text-muted">lightweight form validation script that augments native HTML5 form validation elements and attributes.</p>
            <div>
              <a class="btn btn-sm btn-light-dark rounded-pill px-2" role="button" target="_blank" href="https://github.com/cferdinandi/bouncer">
          ...
          <div class="card-body">
            <form class="validate-me" id="validate-me" data-validate>
              ...
              <div class="mb-3 row">
                ...
                <div class="col-lg-6">
                  <input
                    ...
                    id="url_not_ld"
                    class="form-control"
                    pattern="(?:(?:https?|HTTPS?|ftp|FTP):\/\/)(?:\S+(?::\S*)?@)?(?:(?!(?:10|127)(?:\.\d{(1,
                    3)}){3})(?!(?:169\.254|192\.168)(?:\.\d{(1, 3)}){2})(?!172\.(?:1[6-9]|2\d|3[0-1])(?:\.\d{(1,
                    3)}){2})(?:[1-9]\d?|1\d\d|2[01]\d|22[0-3])(?:\.(?:1?\d{(1,
                    2)}|2[0-4]\d|25[0-5])){2}(?:\.(?:[1-9]\d?|1\d\d|2[0-4]\d|25[0-4]))|(?:(?:[a-zA-Z\u00a1-\uffff0-9]-*)*[a-zA-Z\u00a1-\uffff0-9]+)(?:\.(?:[a-zA-Z\u00a1-\uffff0-9]-*)*[a-zA-Z\u00a1-\uffff0-9]+)*)(?::\d{(2,
                    5)})?(?:[\/?#]\S*)?"
                    required
                  />
                </div>
              ...
              <div class="mb-3 row">
                ...
                <div class="col-lg-6">
                  <input type="number" class="form-control" step="any" name="integer" id="integer" required />
                </div>
              </div>
