...
<svelte:head>
  <title>Pricing 1 | Able Pro Dashboard Template</title>
</svelte:head>
...
<div class="pc-container">
  <div class="pc-content">
    <!-- [ breadcrumb ] start -->
    <Breadcrumb item="Other" itemActive="Pricing" />
    <!-- [ breadcrumb ] end -->
    <!-- [ Main Content ] start -->
            ...
            <div class="card price-card">
              <div class="card-body">
                <div class="price-head">
                  ...
                  <div class="d-grid"><a class="btn btn-outline-secondary mt-4" href="/pages/price-v1">Buy Now</a></div>
                </div>
            ...
            <div class="card price-card price-popular">
              <div class="card-body">
                <div class="price-head">
                  ...
                  <div class="d-grid"><a class="btn btn-primary mt-4" href="/pages/price-v1">Buy Now</a></div>
                </div>
                <ul class="list-group list-group-flush product-list">
                  <li class="list-group-item enable">One End Product</li>
                  <li class="list-group-item enable">No attribution required</li>
