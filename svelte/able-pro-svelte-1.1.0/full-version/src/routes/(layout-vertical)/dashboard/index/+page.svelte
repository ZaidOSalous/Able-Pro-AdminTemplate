          ...
          <div class="card-body">
            ...
            <div class="bg-body p-3 mt-3 rounded">
              <div class="mt-3 row align-items-center">
                <div class="col-7">
                  <div id="all-earnings-graph" use:chart={all_earnings_options}></div>
                </div>
                <div class="col-5">
        ...
        <div class="card">
          <div class="card-body">
            ...
            <div class="bg-body p-3 mt-3 rounded">
              <div class="mt-3 row align-items-center">
                <div class="col-7">
                  <div id="page-views-graph" use:chart={page_views_options}></div>
                </div>
                <div class="col-5">
        ...
        <div class="card">
          <div class="card-body">
            ...
            <div class="bg-body p-3 mt-3 rounded">
              <div class="mt-3 row align-items-center">
                <div class="col-7">
                  <div id="total-task-graph" use:chart={total_task_options}></div>
                </div>
                <div class="col-5">
        ...
        <div class="card">
          <div class="card-body">
            ...
            <div class="bg-body p-3 mt-3 rounded">
              <div class="mt-3 row align-items-center">
                <div class="col-7">
                  <div id="download-graph" use:chart={download_options}></div>
                </div>
                <div class="col-5">
      ...
      <div class="col-lg-9">
        <div class="card">
          <div class="card-body">
            ...
            <div id="customer-rate-graph" use:chart={customer_rate_options}></div>
          </div>
        </div>
      </div>
      <div class="col-lg-3">
            ...
            <div class="row align-items-center justify-content-center">
              <div class="col-md-6 col-xl-4">
                <div class="mt-3 row align-items-center">
                  ...
                  <div class="col-6">
                    <div id="total-tasks-graph" use:chart={total_tasks_options}></div>
                  </div>
                </div>
              </div>
              <div class="col-md-6 col-xl-4">
                <div class="mt-3 row align-items-center">
                  ...
                  <div class="col-6">
                    <div id="pending-tasks-graph" use:chart={pending_tasks_options}></div>
                  </div>
                </div>
              </div>
              <div class="col-md-6 col-xl-4">
      ...
      <div class="col-md-6">
        <div class="card">
          <div class="card-body">
            ...
            <div id="total-income-graph" use:chart={total_income_options}></div>
