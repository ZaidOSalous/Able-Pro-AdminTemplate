...
<div class="pc-container">
  <div class="pc-content">
    <Breadcrumb item="Dashboard" itemActive="Finance" />
    <!-- [ Main Content ] start -->
    <div class="row">
            ...
            <div class="d-flex align-items-center justify-content-between mb-3">
              ...
              <div class="dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-end">
                  <a class="dropdown-item" href="/dashboard/finance">Today</a>
                  <a class="dropdown-item" href="/dashboard/finance">Weekly</a>
                  <a class="dropdown-item" href="/dashboard/finance">Monthly</a>
                </div>
              </div>
            </div>
            <div
      ...
      <div class="col-md-7 col-xxl-8">
          ...
          <div class="col-md-6 col-xxl-4">
            <div class="card">
              <div class="card-body">
                ...
                <div id="total-line-1-chart" use:chart={total_line_chart_options}></div>
          ...
          <div class="col-md-6 col-xxl-4">
            <div class="card">
              <div class="card-body">
                ...
                <div id="total-line-2-chart" use:chart={total_line_chart_options}></div>
                <div class="d-flex align-items-center justify-content-between gap-2 mt-3">
                  <h4 class="mb-0"><small class="text-muted">$</small>650k</h4>
                  <p class="mb-0 text-muted text-sm">Compare to last week</p>
                </div>
          ...
          <div class="col-md-12 col-xxl-4">
            <div class="card">
              <div class="card-body">
                ...
                <div id="total-line-3-chart" use:chart={total_line_3_chart_options}></div>
                <div class="d-flex align-items-center justify-content-between gap-2 mt-3">
                  <h4 class="mb-0"><small class="text-muted">$</small>650k</h4>
                  <p class="mb-0 text-muted text-sm">Compare to last week</p>
                </div>
        ...
        <div class="card">
          <div class="card-body">
            ...
            <div id="cashflow-bar-chart" use:chart={cashflow_bar_chart_options}></div>
          </div>
        </div>
        <div class="card">
          <div class="card-body">
        ...
        <div class="card">
          <div class="card-body">
            ...
            <div class="d-flex align-items-center justify-content-between gap-2 my-3">
              <a href="/dashboard/finance" class="avtar border border-secondary rounded-circle btn-light-secondary">
                <i class="ti ti-plus f-20"></i>
              </a>
              <a href="/dashboard/finance" class="avtar"
                ><img class="rounded-circle img-fluid" src="/assets/images/user/avatar-1.jpg" alt="img" /></a
              >
              <a href="/dashboard/finance" class="avtar"
                ><img class="rounded-circle img-fluid" src="/assets/images/user/avatar-2.jpg" alt="img" /></a
              >
              <a href="/dashboard/finance" class="avtar"
                ><img class="rounded-circle img-fluid" src="/assets/images/user/avatar-3.jpg" alt="img" /></a
              >
              <a href="/dashboard/finance" class="avtar"
                ><img class="rounded-circle img-fluid" src="/assets/images/user/avatar-4.jpg" alt="img" /></a
              >
            </div>
            <ul class="list-group list-group-flush">
              <li class="list-group-item px-0">
      ...
      <div class="col-md-6 col-xxl-4">
        <div class="card">
          <div class="card-body">
            ...
            <div id="category-donut-chart" use:chart={category_donut_chart}></div>
          </div>
        </div>
      </div>
      <div class="col-12">
              ...
              <table class="table table-hover" id="pc-dt-simple">
                ...
                <tbody>
                  <tr>
                    ...
                    <td class="text-end">
                      <a href="/dashboard/finance" class="avtar avtar-xs btn-link-secondary">
