...
<svelte:head>
  <title>Font Awesome Icon Pack | Able Pro Dashboard Template</title>
</svelte:head>

<!-- [ Main Content ] start -->
<div class="pc-container">
  <div class="pc-content">
    <Breadcrumb item="Icons" itemActive="Font Awesome" />
    <!-- [ Main Content ] start -->
    <div class="row">
      ...
      <div class="col-sm-12">
        <div class="card">
          <div class="card-header">
            ...
            <p>
              Use icon with <code>&lt;i class="&lt;&lt; Copied code &gt;&gt;"&gt;</code> in you html code
            </p>
          </div>
