<script>
  ...
  import quill from '$lib/assets/quill.js';
  import dropzone from '$lib/assets/dropzone.js';
...
<svelte:head>
  <title>Site | Able Pro Dashboard Template</title>
...
<div class="pc-container">
  <div class="pc-content">
    <!-- [ breadcrumb ] start -->
    <Breadcrumb item="Online Courses" itemActive="Site" />
    <!-- [ Main Content ] start -->
    <div class="row">
      <!-- [ sample-page ] start -->
      <div class="col-sm-12">
              ...
              <div class="tab-content">
                <div class="tab-pane show active" id="contactDetail">
                  ...
                  <div class="row g-3">
                    <div class="col-sm-12 col-md-4">
                      ...
                      <form action="../assets/json/file-upload.php" class="dropzone" use:dropzone={'/admins/course-site'}>
                        <div class="fallback">
                    ...
                    <div class="col-sm-6 col-md-4">
                      ...
                      <form action="../assets/json/file-upload.php" class="dropzone" use:dropzone={'/admins/couese-site'}>
                        <div class="fallback">
                          <input name="file" type="file" multiple />
                        </div>
                      </form>
                  ...
                  <div class="d-flex align-items-center mb-4">
                    ...
                    <div class="flex-grow-1 ms-3">
                      ...
                      <p class="mb-0 text-muted">
                        Personalize your school and eliminate Able Pro branding from your school website, emails, and products. To access
                        this feature, upgrade to the Professional plan.
                      </p>
                    </div>
                  </div>
                  ...
                  <div class="card border">
                    <div class="card-body">
                      ...
                      <p class="mb-0 text-muted">
                        Make your school your own and remove Teachable branding from your school website, emails, and all
                        products. Upgrade to the Professional plan to use this feature.
                      </p>
                    </div>
                  </div>
                  ...
                  <h5>Color Palette</h5>
                  <p class="text-muted mb-4">
                    Select a predefined color scheme to establish consistency across your site and products. Alternatively, customize your
                    own color palette to reflect your unique branding and preferences.
                  </p>
                  <div class="card border">
                    <div class="card-body">
                      <div class="row g-4 mb-4">
                        <div class="col-md-6 col-xl-3">
                          <div class="set-color-block">
                        ...
                        <div class="col-md-6 col-xl-3">
                          <div class="set-color-block active">
                ...
                <div class="tab-pane" id="educationDetail">
                  <div class="text-end mb-3">
                    <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#exampleModal"> Add Bio </button>
                  </div>
                    ...
                    <div class="modal-dialog">
                      <div class="modal-content">
                        ...
                        <div class="modal-body">
                          ...
                          <div id="pc-quil-1" style="height: 125px" use:quill={quill_options}></div>
                          ...
                          <tbody>
                            <tr>
                              <td>
                                <div class="d-flex align-items-center">
                                  <div class="flex-shrink-0">
                                    <img src="/assets/images/user/avatar-1.jpg" alt="img" class="img-radius wid-40" />
                                  </div>
                                  <div class="flex-grow-1 ms-3">
                              ...
                              <td>
                                <a href="/admins/course-site" class="avtar avtar-xs btn-link-secondary">
                            ...
                            <tr>
                              <td>
                                <div class="d-flex align-items-center">
                                  <div class="flex-shrink-0">
                                    <img src="/assets/images/user/avatar-2.jpg" alt="img" class="img-radius wid-40" />
                                  </div>
                                  <div class="flex-grow-1 ms-3">
                            ...
                            <tr>
                              <td>
                                <div class="d-flex align-items-center">
                                  <div class="flex-shrink-0">
                                    <img src="/assets/images/user/avatar-3.jpg" alt="img" class="img-radius wid-40" />
                                  </div>
                                  <div class="flex-grow-1 ms-3">
                            ...
                            <tr>
                              <td>
                                <div class="d-flex align-items-center">
                                  <div class="flex-shrink-0">
                                    <img src="/assets/images/user/avatar-4.jpg" alt="img" class="img-radius wid-40" />
                                  </div>
                                  <div class="flex-grow-1 ms-3">
                            ...
                            <tr>
                              <td>
                                <div class="d-flex align-items-center">
                                  <div class="flex-shrink-0">
                                    <img src="/assets/images/user/avatar-5.jpg" alt="img" class="img-radius wid-40" />
                                  </div>
                                  <div class="flex-grow-1 ms-3">
                                    <h6 class="mb-0">Airi Satou</h6>
                                  </div>
                            ...
                            <tr>
                              <td>
                                <div class="d-flex align-items-center">
                                  <div class="flex-shrink-0">
                                    <img src="/assets/images/user/avatar-6.jpg" alt="img" class="img-radius wid-40" />
                                  </div>
                                  <div class="flex-grow-1 ms-3">
                                    <h6 class="mb-0">Ashton Cox</h6>
                                  </div>
                            ...
                            <tr>
                              <td>
                                <div class="d-flex align-items-center">
                                  <div class="flex-shrink-0">
                                    <img src="/assets/images/user/avatar-7.jpg" alt="img" class="img-radius wid-40" />
                                  </div>
                                  <div class="flex-grow-1 ms-3">
                                    <h6 class="mb-0">Bradley Greer</h6>
                                  </div>
                      ...
                      <ul class="nav nav-tabs profile-tabs" id="myTab" role="tablist">
                        <li class="nav-item" role="presentation">
                          <button
                            ...
                            aria-selected="true">School Pages</button
                          >
                        </li>
                        <li class="nav-item" role="presentation">
                          <button
                            ...
                            aria-selected="false">Product Pages</button
                          >
                        </li>
                      </ul>
                    </div>
                ...
                <div class="d-sm-flex wizard justify-content-between mt-3">
                  ...
                  <div class="d-sm-flex">
                    <div class="previous me-2">
                      <a href="javascript:void(0);" class="btn btn-secondary mt-3 mt-md-0"> Back To Previous </a>
                    </div>
                    <div class="next">
                      <a href="javascript:void(0);" class="btn btn-secondary mt-3 mt-md-0"> Next Step </a>
                    </div>
                  </div>
                  <div class="last">
