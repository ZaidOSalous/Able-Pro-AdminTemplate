...
<div class="pc-container">
  <div class="pc-content">
    <!-- [ breadcrumb ] start -->
    <Breadcrumb item="Online Courses" itemActive="Pricing" />
    <!-- [ breadcrumb ] end -->
    <!-- [ Main Content ] start -->
    <div class="row">
      <div class="col-12">
                ...
                <ul class="nav nav-pills nav-price" id="pills-tab" role="tablist">
                  ...
                  <li class="nav-item" role="presentation">
                    <button
                      ...
                      aria-selected="false">Yearly <span class="badge bg-primary ms-2">Save 30%</span></button
                    >
                  </li>
                </ul>
              </div>
                ...
                <div class="card price-card">
                  <div class="card-body">
                    <div class="price-head v2">
                      ...
                      <div class="d-grid"><a class="btn btn-outline-secondary mt-4" href="/admins/course-setting-pricing">Buy Now</a></div>
                    </div>
                ...
                <div class="card price-card price-popular">
                  <div class="card-body">
                    <div class="price-head v2">
                      ...
                      <div class="d-grid"><a class="btn btn-primary mt-4" href="/admins/course-setting-pricing">Buy Now</a></div>
                    </div>
                    <ul class="list-group list-group-flush product-list">
                      <li class="list-group-item enable">One End Product</li>
                      <li class="list-group-item enable">No attribution required</li>
