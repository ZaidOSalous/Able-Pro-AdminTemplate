...
<svelte:head>
  <title>Customers | Able Pro Dashboard Template</title>
</svelte:head>
...
<div class="pc-container">
  <div class="pc-content">
    ...
    <Breadcrumb item="Helpdesk" itemActive="Customers" />
    <!-- [ breadcrumb ] end -->
        ...
        <div class="card shadow-none">
                  ...
                  <div class="modal-content">
                    <div class="modal-header">
                      <h5 class="modal-title" id="exampleModalLabel">
                        <i data-feather="user" class="icon-svg-primary wid-20 me-2"></i>Add Customer
                      </h5>
          ...
          <div class="card-body shadow border-0">
            <div class="table-responsive">
              <table id="report-table" class="table table-bordered table-striped mb-0" use:dataTable={report_table}>
                <thead>
                  <tr>
