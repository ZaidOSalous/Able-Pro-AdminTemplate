...
<svelte:head>
  <title>Pricing | Able Pro Dashboard Template</title>
</svelte:head>
<!-- [ Main Content ] start -->
<div class="pc-container">
  <div class="pc-content">
    <!-- [ breadcrumb ] start -->
    <Breadcrumb item="Helpdesk" itemActive="Dashboard" />
    <!-- [ breadcrumb ] end -->
    ...
    <div class="row">
      ...
      <div class="col-xl-4 col-md-6">
        <div class="card support-bar">
          ...
          <div id="support-chart" use:chart={support_chart} style="height: 100px; width: 100%"></div>
      ...
      <div class="col-xl-4 col-md-6">
        <div class="card support-bar">
          ...
          <div id="support-chart1" use:chart={support_chart1} style="height: 100px; width: 100%"></div>
      ...
      <div class="col-xl-4 col-md-12">
        <div class="card support-bar">
          ...
          <div id="support-chart2" use:chart={support_chart2} style="height: 100px; width: 100%"></div>
        ...
        <div class="card">
          <div class="card-body">
            ...
            <div class="row d-flex justify-content-center align-items-center">
              <div class="col">
                <div id="satisfaction-chart" use:chart={satisfaction_chart} style="height: 200px"></div>
              </div>
            </div>
          </div>
        </div>
            ...
            <div class="d-flex align-items-center justify-content-between">
              ...
              <div class="dropdown">
                <a
                  ...
                  href="/admins/helpdesk-dashboard"
                ...
                <div class="dropdown-menu dropdown-menu-end">
                  <a class="dropdown-item" href="/admins/helpdesk-dashboard">Today</a>
                  <a class="dropdown-item" href="/admins/helpdesk-dashboard">Weekly</a>
                  <a class="dropdown-item" href="/admins/helpdesk-dashboard">Monthly</a>
                </div>
              </div>
            </div>
          </div>
          <div class="latest-scroll" style="height: 400px; position: relative" use:simplebar>
            <div class="card-body">
              <div class="row align-items-center m-b-30">
                ...
                <div class="col">
                  <a href="#!">
                    <h6>
                      You have 3 pending tasks. <span class="text-muted float-end f-13">Just Now</span>
                    </h6>
                  </a>
                </div>
              </div>
              <div class="row align-items-center m-b-30">
                ...
                <div class="col">
                  <a href="#!">
                    <h6>
                      New order received <span class="text-muted float-end f-13">Just Now</span>
                    </h6>
                  </a>
                </div>
              </div>
              ...
              <div class="col-8">
                <div class="p-t-25 p-b-25">
                  ...
                  <p class="text-muted m-0">
                    Tickets <span class="text-primary f-w-400">Answered</span>
                  </p>
                </div>
              </div>
            </div>
