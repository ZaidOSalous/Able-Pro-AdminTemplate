...
<svelte:head>
  <title>Invoice | Able Pro Dashboard Template</title>
</svelte:head>
<!-- [ Main Content ] start -->
<div class="pc-container">
  <div class="pc-content">
    <!-- [ breadcrumb ] start -->
    <Breadcrumb item="Invoice" itemActive="Dashboard" />
    <!-- [ breadcrumb ] end -->
    ...
    <div class="row">
      <div class="col-lg-9">
        <div class="card">
          <div class="card-body">
            ...
            <div id="invoice-chart" use:chart={options_invoice}></div>
          </div>
        </div>
      </div>
      <div class="col-lg-3">
        ...
        <div class="card">
            ...
            <div class="d-flex align-items-center justify-content-between">
              ...
              <div class="dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-end">
                  <a class="dropdown-item" href="/admins/invoice-dashboard">Today</a>
                  <a class="dropdown-item" href="/admins/invoice-dashboard">Weekly</a>
                  <a class="dropdown-item" href="/admins/invoice-dashboard">Monthly</a>
                </div>
              </div>
            </div>
          </div>
          <ul class="list-group list-group-flush border-top-0">
            <li class="list-group-item border-0">
              <div class="d-flex align-items-center">
                <div class="flex-shrink-0">
                  <img src="/assets/images/user/avatar-10.jpg" alt="img" class="user-avtar rounded-circle wid-40 hie-40" />
                </div>
            ...
            <li class="list-group-item border-0">
              <div class="d-flex align-items-center">
                <div class="flex-shrink-0">
                  <img src="/assets/images/user/avatar-2.jpg" alt="img" class="user-avtar rounded-circle wid-40 hie-40" />
                </div>
                <div class="flex-grow-1 mx-2">
            ...
            <li class="list-group-item border-0">
              <div class="d-flex align-items-center">
                <div class="flex-shrink-0">
                  <img src="/assets/images/user/avatar-3.jpg" alt="img" class="user-avtar rounded-circle wid-40 hie-40" />
                </div>
                <div class="flex-grow-1 mx-2">
      ...
      <div class="col-xl-4 col-md-6">
        <div class="card">
          ...
          <div class="card-body">
            <div id="total-income-graph" use:chart={total_income_graph_options}></div>
            <div class="mb-2 mt-3 d-flex align-items-center justify-content-between">
              <h6 class="mb-0 d-flex align-items-center gap-2">
                <i class="fas fa-circle text-warning f-12"></i> Pending
              </h6>
              <p class="mb-0 text-muted">$3,202</p>
            </div>
            <div class="mb-2 d-flex align-items-center justify-content-between">
              <h6 class="mb-0 d-flex align-items-center gap-2">
                <i class="fas fa-circle text-success f-12"></i> Paid
              </h6>
              <p class="mb-0 text-muted">$45,050</p>
            </div>
            <div class="mb-2 d-flex align-items-center justify-content-between">
              <h6 class="mb-0 d-flex align-items-center gap-2">
                <i class="fas fa-circle text-danger f-12"></i> Overdue
              </h6>
              <p class="mb-0 text-muted">$25,000</p>
            </div>
            <div class="d-flex align-items-center justify-content-between">
              <h6 class="mb-0 d-flex align-items-center gap-2">
                <i class="fas fa-circle text-primary text-opacity-25 f-12"></i> Draft
              </h6>
          ...
          <ul class="list-group list-group-flush border-top-0">
            <li class="list-group-item border-0">
              <div class="d-flex align-items-center">
                ...
                <div class="flex-grow-1 mx-2">
                  <h6 class="mb-1">
                    Johnny sent you an invoice billed <a href="#!" class="link-primary">$1,000</a>.
                  </h6>
                  <p class="mb-0 text-muted text-sm">2 August</p>
                </div>
                <div class="flex-shrink-0">
                  <a href="#!" class="avtar avtar-s btn-link-secondary"><i class="ti ti-link f-20"></i></a>
                </div>
              </div>
            </li>
            <li class="list-group-item border-0">
              <div class="d-flex align-items-center">
                ...
                <div class="flex-grow-1 mx-2">
                  <h6 class="mb-1">
                    Sent an invoice to Aida Bugg amount of <a href="#!" class="link-primary">$200</a>.
                  </h6>
