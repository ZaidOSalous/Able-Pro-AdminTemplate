...
<title>Edit Invoice | Able Pro Dashboard Template</title>
<!-- [ Main Content ] start -->
<div class="pc-container">
  <div class="pc-content">
    <Breadcrumb item="Invoice" itemActive="Edit" />
    <!-- [ breadcrumb ] end -->
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td class="text-center">
                          <a href="/admins/invoice-edit" class="avtar avtar-s btn-link-danger btn-pc-default"
      ...
      <div class="modal-footer justify-content-between collapse multi-collapse show">
        <ul class="list-inline me-auto mb-0">
          <li class="list-inline-item align-bottom">
            <a href="/admins/invoice-edit" class="avtar avtar-s btn-link-danger w-sm-auto" data-bs-toggle="tooltip" title="Delete">
