...
<svelte:head>
  <title>Create Invoice | Able Pro Dashboard Template</title>
</svelte:head>
...
<div class="pc-container">
  <div class="pc-content">
    <!-- [ breadcrumb ] start -->
    <Breadcrumb item="Invoice" itemActive="Create" />
    <!-- [ breadcrumb ] end -->
                ...
                <div class="border rounded p-3 h-100">
                  <div class="d-flex align-items-center justify-content-between">
                    ...
                    <button
                      class="btn btn-sm btn-outline-secondary d-flex align-items-center gap-2"
                      data-bs-toggle="modal"
                      data-bs-target="#address-edit_add-modal"><i class="ph-duotone ph-plus-circle"></i> Add</button
                    >
                  </div>
                </div>
              </div>
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td class="text-center">
                          <a href="/admins/invoice-create" class="avtar avtar-s btn-link-danger btn-pc-default"
      ...
      <div class="modal-footer justify-content-between collapse multi-collapse show">
        <ul class="list-inline me-auto mb-0">
          <li class="list-inline-item align-bottom">
            <a href="/admins/invoice-create" class="avtar avtar-s btn-link-danger w-sm-auto" data-bs-toggle="tooltip" title="Delete">
