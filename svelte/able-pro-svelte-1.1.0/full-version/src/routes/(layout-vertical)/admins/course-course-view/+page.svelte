...
<svelte:head>
  <title>Courses View | Able Pro Dashboard Template</title>
</svelte:head>
<!-- [ Main Content ] start -->
<div class="pc-container">
  <div class="pc-content">
    <!-- [ breadcrumb ] start -->
    <Breadcrumb item="Online Courses" itemActive="Courses View" />
    <!-- [ breadcrumb ] end -->
                      ...
                      <li class="list-group-item px-0 py-2">
                        <div class="d-flex align-items-center">
                          ...
                          <div class="flex-shrink-0">
                            <a href="/admins/course-course-view" class="avtar avtar-xs btn-link-secondary">
