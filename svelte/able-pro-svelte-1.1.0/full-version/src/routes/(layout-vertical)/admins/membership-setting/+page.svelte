...
<svelte:head>
  <title>Setting | Able Pro Dashboard Template</title>
</svelte:head>
...
<div class="pc-container">
  <div class="pc-content">
    <!-- [ breadcrumb ] start -->
    <Breadcrumb item="Membership" itemActive="Setting" />
    <!-- [ breadcrumb ] end -->
    <!-- [ Main Content ] start -->
    <div class="row">
      <div class="col-12">
        <div class="card">
          <div class="card-header d-flex align-items-center justify-content-between py-3">
            <h5>Setting</h5>
            <a class="avtar avtar-s btn-link-secondary" href="/admins/membership-setting">
                    ...
                    <div class="card shadow-none border mb-0 h-100">
                      <div class="card-body">
                        ...
                        <p>
                          ...
                          <a href="/admins/membership-setting" class="link-primary text-decoration-underline">Reset your password</a>
                        </p>
              ...
              <div class="col-md-6 col-xl-4">
                <div class="card shadow-none border mb-0">
                  <div class="card-body">
                    ...
                    <a href="/admins/membership-setting" class="link-primary d-flex align-items-center gap-2"
                      >See more Plan <i class="ti ti-chevron-right"></i></a
                    >
                  </div>
                </div>
              </div>
              <div class="col-md-6 col-xl-4">
                <div class="card shadow-none border mb-0">
                  <div class="card-body">
                    ...
                    <a href="/admins/membership-setting" class="link-primary d-flex align-items-center gap-2"
                      >Update, Cancel and more <i class="ti ti-chevron-right"></i></a
                    >
                  </div>
                </div>
              </div>
              <div class="col-md-12 col-xl-4">
                <div class="card shadow-none border mb-0">
                  <div class="card-body">
                    ...
                    <a href="/admins/membership-setting" class="link-primary d-flex align-items-center gap-2"
                      >View payment method <i class="ti ti-chevron-right"></i></a
                    >
                  </div>
                </div>
              </div>
