...
<div class="pc-container">
  <div class="pc-content">
    <!-- [ breadcrumb ] start -->
    <Breadcrumb item="Helpdesk" itemActive="Ticket list" />
    <!-- [ breadcrumb ] end -->
    <!-- [ Main Content ] start -->
    <div class="row">
          ...
          <div class="card-body">
            <nav class="navbar justify-content-between p-0 align-items-center">
              ...
              <div class="btn-group btn-group-sm help-filter" role="group" aria-label="button groups sm">
                <a class="btn btn-light-secondary" on:click={() => filterchange('sm')}><i class="feather icon-align-justify m-0"></i></a>
                <a class="btn btn-light-secondary" on:click={() => filterchange('md')}><i class="feather icon-menu m-0"></i></a>
                <a class="btn btn-light-secondary active" on:click={() => filterchange('large')}><i class="feather icon-grid m-0"></i></a>
              </div>
            </nav>
          </div>
        </div>
            ...
            <div class="row">
              <div class="col-sm-auto mb-3 mb-sm-0">
                <div class="d-sm-inline-block d-flex align-items-center">
                  <img class="media-object wid-60 img-radius" src="/assets/images/user/avatar-1.jpg" alt="img" />
                  <div class="ms-3 ms-sm-0">
                    <ul class="text-sm-center list-unstyled mt-2 mb-0 d-inline-block">
                      <li class="list-unstyled-item">
                        <a href="/admins/helpdesk-ticket" class="link-secondary">1 Ticket</a>
                      </li>
                      <li class="list-unstyled-item">
                        <a href="/admins/helpdesk-ticket" class="link-danger"><i class="fas fa-heart"></i> 3</a>
                      </li>
                    </ul>
                  </div>
                </div>
              ...
              <div class="col">
                <div class="popup-trigger">
                  <div class="h5 font-weight-bold">
                    John lui <small class="badge bg-light-secondary ms-2">Replied</small>
                  </div>
                  <div class="help-sm-hidden">
                    <ul class="list-unstyled mt-2 mb-0 text-muted">
                      <li class="d-sm-inline-block d-block mt-1">
                        <img src="/assets/images/admin/p1.jpg" alt="" class="wid-20 rounded me-2 img-fluid" />Piaf able
                      </li>
                      <li class="d-sm-inline-block d-block mt-1">
                        <img src="/assets/images/user/avatar-5.jpg" alt="" class="wid-20 rounded me-2 img-fluid" />Assigned to
                        <b>Robert alia</b>
                      </li>
                      <li class="d-sm-inline-block d-block mt-1">
                        <i class="wid-20 material-icons-two-tone text-center f-14 me-2">calendar_today</i>Updated 22 hours ago
                      </li>
                      <li class="d-sm-inline-block d-block mt-1">
                  ...
                  <div class="h5 mt-3">
                    <i class="material-icons-two-tone f-16 me-1">lock</i> Theme customisation issue
                  </div>
                  <div class="help-md-hidden">
                    <div class="bg-body mb-3 p-3">
                      <h6>
                        <img src="/assets/images/user/avatar-5.jpg" alt="" class="wid-20 avatar me-2 rounded" />Last comment from
                        <a href="/admins/helpdesk-ticket" class="link-secondary">Robert alia:</a>
                      </h6>
                      <p class="mb-0">
                ...
                <div class="mt-2">
                  <a href="/admins/helpdesk-ticket-details" class="me-2 btn btn-sm btn-light-primary"
                    ><i class="feather icon-eye mx-1"></i>View Ticket</a
                  >
                  <a href="/admins/helpdesk-ticket" class="me-3 btn btn-sm btn-light-danger"
                    ><i class="feather icon-trash-2 mx-1"></i>Delete</a
                  >
                </div>
              </div>
            </div>
            ...
            <ul class="list-group list-group-flush pb-2">
              <li class="list-group-item">
                <div class="d-inline-block">
                  ...
                  <a href="/admins/helpdesk-ticket" class="link-secondary">Piaf able</a>
                </div>
                <div class="float-end">
                  <a
                    href="/admins/helpdesk-ticket"
                    class="badge bg-light-danger rounded-circle me-1"
                  ...
                  <a
                    href="/admins/helpdesk-ticket"
                    class="badge bg-light-secondary rounded-circle me-0"
                    data-bs-toggle="tooltip"
                    data-bs-placement="top"
                    title=""
              ...
              <li class="list-group-item">
                <div class="d-inline-block">
                  ...
                  <a href="/admins/helpdesk-ticket" class="link-secondary">Pro able</a>
                </div>
                <div class="float-end">
                  <a
                    href="/admins/helpdesk-ticket"
              ...
              <li class="list-group-item">
                <div class="d-inline-block">
                  ...
                  <a href="/admins/helpdesk-ticket" class="link-secondary">CRM admin</a>
                </div>
                <div class="float-end">
                  <a
                    href="/admins/helpdesk-ticket"
              ...
              <li class="list-group-item">
                <div class="d-inline-block">
                  ...
                  <a href="/admins/helpdesk-ticket" class="link-secondary">Alpha pro</a>
                </div>
                <div class="float-end">
                  <a
                    href="/admins/helpdesk-ticket"
              ...
              <li class="list-group-item">
                <div class="d-inline-block">
                  ...
                  <a href="/admins/helpdesk-ticket" class="link-secondary">Carbon able</a>
                </div>
                <div class="float-end">
                  <a
                    href="/admins/helpdesk-ticket"
            ...
            <ul class="list-group list-group-flush pb-2">
              <li class="list-group-item">
                <div class="d-inline-block">
                  ...
                  <a href="/admins/helpdesk-ticket" class="link-secondary">Tom Cook</a>
                </div>
                <div class="float-end">
                  <a
                    href="/admins/helpdesk-ticket"
              ...
              <li class="list-group-item">
                <div class="d-inline-block">
                  ...
                  <a href="/admins/helpdesk-ticket" class="link-secondary">Brad Larry</a>
                </div>
                <div class="float-end">
                  <a
                    href="/admins/helpdesk-ticket"
              ...
              <li class="list-group-item">
                <div class="d-inline-block">
                  ...
                  <a href="/admins/helpdesk-ticket" class="link-secondary">Jhon White</a>
                </div>
                <div class="float-end">
                  <a
                    href="/admins/helpdesk-ticket"
              ...
              <li class="list-group-item">
                <div class="d-inline-block">
                  ...
                  <a href="/admins/helpdesk-ticket" class="link-secondary">Mark Jobs</a>
                </div>
                <div class="float-end">
                  <a
                    href="/admins/helpdesk-ticket"
              ...
              <li class="list-group-item">
                <div class="d-inline-block">
                  ...
                  <a href="/admins/helpdesk-ticket" class="link-secondary">Able Pro</a>
                </div>
                <div class="float-end">
                  <a
                    href="/admins/helpdesk-ticket"
        ...
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title"
              >Chrome bug The page uses a roller to slide under a black block<span class="badge bg-light-danger text-uppercase ms-2 f-12"
                >Private</span
              ></h5
            >
          ...
          <div class="scroll-div position-relative" style="height: calc(100vh - 90px)">
              ...
              <div class="row">
                <div class="col-md-7">
                  ...
                  <p class="list-inline-item mb-0"
                    ><img src="/assets/images/admin/p1.jpg" alt="" class="wid-20 rounded me-1 img-fluid" />Alpha pro</p
                  >
                </div>
                <div class="col-md-5 text-end">
                  <p class="d-inline-block mb-0"
                    ><i class="wid-20 material-icons-two-tone text-center f-16 me-2">calendar_today</i
                    ><label class="mb-0">Jan,1st,2019</label></p
                  >
                </div>
              </div>
            </div>
            <div class="modal-body border-bottom px-4">
              <div class="row">
                <div class="col-auto">
                  <img class="media-object wid-60 img-radius" src="/assets/images/user/avatar-5.jpg" alt="img" />
                </div>
                <div class="col">
                ...
                <div class="col-auto">
                  <ul class="list-unstyled mb-0">
                    <li class="d-inline-block me-1"
                      ><a href="/admins/helpdesk-ticket"><i class="feather icon-edit text-muted"></i></a
                    ></li>
                    <li class="d-inline-block"
                      ><a href="/admins/helpdesk-ticket"><i class="feather icon-trash-2 text-muted"></i></a
                    ></li>
                  </ul>
                </div>
              </div>
