<script>
  ...
  let activeTab = '#auth-1';
  // Function to change the tab
  function changeTab(tabName) {
    activeTab = tabName;
    let getTabPane = document.querySelector(tabName);
    let getActivePane = document.querySelector('.tab-pane.active');
    if (getActivePane) {
      getActivePane.classList.remove('active', 'show');
    }
    if (getTabPane) {
      getTabPane.classList.add('active', 'show');
    }
  }
</script>

<svelte:head>
  <title>Setting Payment | Able Pro Dashboard Template</title>
</svelte:head>

<div class="pc-container">
  <div class="pc-content">
    <!-- [ breadcrumb ] start -->
    <Breadcrumb item="Online Courses" itemActive="Setting Payment" />
    <!-- [ breadcrumb ] end -->
    <!-- [ Main Content ] start -->
    <div class="row">
      <div class="col-12">
          ...
          <div class="card-body">
            ...
            <div class="tab-content">
                  ...
                  <div class="col-md-10 col-lg-8 col-xxl-6">
                    <div class="card border text-center">
                      <div class="card-body">
                        ...
                        <p class="text-muted"
                          >Able Pro: pay streamlines your payout process, facilitating faster payments while managing author and affiliate
                          payouts on your behalf.</p
                        >
                        <div class="mb-3 text-start">
                          ...
                          <div class="d-flex align-items-center">
                            ...
                            <div class="flex-shrink-0">
                              <button class="btn btn-primary" on:click={() => changeTab('#auth-2')}>Confirm</button>
                            </div>
                          </div>
                        </div>
                      </div>
              ...
              <div class="tab-pane" id="auth-2" role="tabpanel" aria-labelledby="auth-tab-2">
                <button class="btn btn-link-secondary d-flex align-items-center" on:click={() => changeTab('#auth-1')}
                    ...
                    <div class="card border text-center">
                      <div class="card-body">
                        ...
                        <div class="row g-3 justify-content-center">
                          <div class="col-auto">
                            <button class="btn btn-outline-secondary" on:click={() => changeTab('#auth-1')} onClick="change_tab('#auth-1')"
                              >Back</button
                            >
                          </div>
                          <div class="col-auto">
                            <button class="btn btn-primary" on:click={() => changeTab('#auth-3')} onClick="change_tab('#auth-3')"
                              >Confirm</button
                            >
                          </div>
                        </div>
              ...
              <div class="tab-pane" id="auth-3" role="tabpanel" aria-labelledby="auth-tab-3">
                <button
                  class="btn btn-link-secondary d-flex align-items-center"
                  on:click={() => changeTab('#auth-2')}
                  onClick="change_tab('#auth-2')"><i class="ti ti-chevron-left"></i> Back Step</button
                >
                <div class="row justify-content-center">
                  <div class="col-md-10 col-lg-8 col-xxl-6">
                    <div class="card border text-center">
                      <div class="card-body">
                        ...
                        <button class="btn btn-primary" on:click={() => changeTab('#auth-4')} onClick="change_tab('#auth-4')"
                          >Confirm</button
                        >
                      </div>
                    </div>
              ...
              <div class="tab-pane" id="auth-4" role="tabpanel" aria-labelledby="auth-tab-4">
                <button
                  class="btn btn-link-secondary d-flex align-items-center"
                  on:click={() => changeTab('#auth-3')}
                  onClick="change_tab('#auth-3')"><i class="ti ti-chevron-left"></i> Back Step</button
                >
                <div class="row justify-content-center">
                  <div class="col-md-10 col-lg-8 col-xxl-6">
                    <div class="card border text-center">
