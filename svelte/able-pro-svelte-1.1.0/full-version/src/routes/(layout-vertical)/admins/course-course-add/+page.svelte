...
<svelte:head>
  <title>Course Add | Able Pro Dashboard Template</title>
...
<div class="pc-container">
  <div class="pc-content">
    <!-- [ breadcrumb ] start -->
    <Breadcrumb item="Online Courses" itemActive="Course Add" />
    <!-- [ breadcrumb ] end -->
    <!-- [ Main Content ] start -->
    <div class="row">
      <div class="col-12">
        <div class="card">
          ...
          <div class="card-body">
            <div class="row">
              ...
              <div class="col-md-6">
                <div class="mb-3">
                  <form action="../assets/json/file-upload.php" class="dropzone" use:dropzone={'/admins/course-course-add'}>
                    <div class="fallback">
