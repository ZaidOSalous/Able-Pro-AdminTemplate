...
<div class="pc-container">
  <div class="pc-content">
    <Breadcrumb item="E-commerce" itemActive="Products Details" />
    <!-- [ Main Content ] start -->
    <div class="row">
      <!-- [ sample-page ] start -->
      <div class="col-sm-12">
          ...
          <div class="card-body">
            <div class="row">
                      ...
                      <div class="card-body position-absolute bottom-0 end-0">
                        <ul class="list-inline ms-auto mb-0 prod-likes">
                          <li class="list-inline-item m-0">
                            <a href="/application/ecom_product-details" class="avtar avtar-xs text-white text-hover-primary">
              ...
              <div class="col-md-6">
                    ...
                    <div class="form-check">
                      ...
                      <label class="form-check-label d-block" for="customCheckdef1">
                        ...
                        <span class="text-muted offer-details"
                          >Upto ₹2,322.51 EMI interest savings on select Credit CardsUpto ₹2,322.51 EMI interest savings on select Credit
                          Cards</span
                        >
                  ...
                  <div class="offer-check border rounded p-3">
                    <div class="form-check">
                      ...
                      <label class="form-check-label d-block" for="customCheckdef2">
                        ...
                        <span class="text-muted offer-details"
                          >Upto ₹1,250.00 discount on select Credit CardsUpto ₹2,322.51 EMI interest savings on select Credit Cards</span
                        >
                        <span class="h6 mb-0 text-primary">1 Offer <i class="ti ti-arrow-narrow-right"></i></span>
                      </label>
                    </div>
                ...
                <div class="mb-3 row">
                  ...
                  <div class="col-lg-6 col-md-12 col-sm-12">
                    <div class="btn-group btn-group-sm mb-2 border" role="group">
                      <button type="button" id="decrease" on:click={() => decreaseValue('number')} class="btn btn-link-secondary"
                ...
                <h3 class="mb-4">
                  <b>$299.00</b><span class="mx-2 f-16 text-muted f-w-400 text-decoration-line-through">$399.00</span>
                </h3>
                <div class="row">
                  <div class="col-6">
                    <div class="d-grid">
              ...
              <div class="tab-pane" id="ecomtab-3" role="tabpanel" aria-labelledby="ecomtab-tab-3">
                <div class="table-responsive">
                  <p class="text-muted">
                    ...
                    It was popularized in the 1960s with the release of Lestrade sheets containing Lorem Ipsum passages, and more recently with
                    desktop publishing software like PageMaker including versions of Lorem Ipsum.
                  </p>
                  <p class="text-muted">
                    It was popularized in the 1960s with the release of Learjet sheets containing Lorem Ipsum passages, and more recently
                    with desktop publishing software like PageMaker including versions of Lorem Ipsum.
                  </p>
                </div>
              </div>
              <div class="tab-pane" id="ecomtab-4" role="tabpanel" aria-labelledby="ecomtab-tab-4">
                  ...
                  <div class="card-body">
                    <div class="d-flex align-items-start">
                      <div class="chat-avtar">
                        <img class="img-radius img-fluid wid-40" src="/assets/images/user/avatar-1.jpg" alt="img" />
                ...
                <div class="card">
                  <div class="card-body">
                    <div class="d-flex align-items-start">
                      <div class="chat-avtar">
                        <img class="img-radius img-fluid wid-40" src="/assets/images/user/avatar-2.jpg" alt="img" />
                        <div class="bg-success chat-badge"></div>
                      </div>
                      <div class="flex-grow-1 ms-3">
                        ...
                        <a href="/application/ecom_product-details" class="link-primary mb-1">https://phoenixcoded.net/</a>
                      </div>
                    </div>
                  </div>
                </div>
            ...
            <div class="row">
                ...
                <div class="card product-card">
                  <div class="card-img-top">
                    <a href="/application/ecom_product-details">
                      <img src="/assets/images/application/img-prod-1.jpg" alt="img" class="img-prod img-fluid" />
                    </a>
                    <div class="card-body position-absolute end-0 top-0">
                      <div class="form-check prod-likes">
              ...
              <div class="col-sm-6 col-xl-3">
                <div class="card product-card">
                  <div class="card-img-top">
                    <a href="/application/ecom_product-details">
                      <img src="/assets/images/application/img-prod-2.jpg" alt="img" class="img-prod img-fluid" />
                    </a>
                    <div class="card-body position-absolute end-0 top-0">
                      <div class="form-check prod-likes">
                        <input type="checkbox" class="form-check-input" />
              ...
              <div class="col-sm-6 col-xl-3">
                <div class="card product-card">
                  <div class="card-img-top">
                    <a href="/application/ecom_product-details">
                      <img src="/assets/images/application/img-prod-3.jpg" alt="img" class="img-prod img-fluid" />
                    </a>
                    <div class="card-body position-absolute end-0 top-0">
                      <div class="form-check prod-likes">
                        <input type="checkbox" class="form-check-input" />
                  ...
                  <div class="card-body">
                    ...
                    <div class="d-flex align-items-center justify-content-between mt-2">
                      <h4 class="mb-0 text-truncate">
                        <b>$299.00</b>
                        <span class="text-sm text-muted f-w-400 text-decoration-line-through">$399.00</span>
                      </h4>
                      <div class="prod-color">
              ...
              <div class="col-sm-6 col-xl-3">
                <div class="card product-card">
                  <div class="card-img-top">
                    <a href="/application/ecom_product-details">
                      <img src="/assets/images/application/img-prod-4.jpg" alt="img" class="img-prod img-fluid" />
                    </a>
                    <div class="card-body position-absolute end-0 top-0">
                      <div class="form-check prod-likes">
                        <input type="checkbox" class="form-check-input" checked />
