...
<div class="pc-container">
  <div class="pc-content">
    <Breadcrumb item="Customer" itemActive="List" />
    <!-- [ Main Content ] start -->
    <div class="row">
      <!-- [ sample-page ] start -->
      <div class="col-sm-12">
        <div class="card table-card">
          <div class="card-body">
            <div class="text-end p-4 pb-sm-2">
              <a
                href="/application/cust_customer_list"
                ...
                <tbody>
                    ...
                    <td class="text-center">
                      <ul class="list-inline me-auto mb-0">
                        ...
                        <li class="list-inline-item align-bottom" data-bs-toggle="tooltip" title="Delete">
                          <a href="/application/cust_customer_list" class="avtar avtar-xs btn-link-danger btn-pc-default">
                  ...
                  <tr>
                    ...
                    <td>
                      <div class="row">
                        <div class="col-auto">
                          <img src="/assets/images/user/avatar-7.jpg" alt="img" class="wid-40 rounded-circle" />
                        </div>
                        <div class="col">
                          <h6 class="mb-0">Agnes McGee</h6>
                          <p class="text-muted f-12 mb-0">heba@gmail.com</p>
                  ...
                  <tr>
                    ...
                    <td>
                      <div class="row">
                        <div class="col-auto">
                          <img src="/assets/images/user/avatar-8.jpg" alt="img" class="wid-40 rounded-circle" />
                        </div>
                        <div class="col">
                          <h6 class="mb-0">Alberta Robbins</h6>
                          <p class="text-muted f-12 mb-0">miza@gmail.com</p>
                  ...
                  <tr>
                    ...
                    <td>
                      <div class="row">
                        <div class="col-auto">
                          <img src="/assets/images/user/avatar-9.jpg" alt="img" class="wid-40 rounded-circle" />
                        </div>
                        <div class="col">
                          <h6 class="mb-0">Agnes McGee</h6>
                          <p class="text-muted f-12 mb-0">heba@gmail.com</p>
  ...
  <div class="modal-dialog modal-lg modal-dialog-centered modal-dialog-scrollable">
    <div class="modal-content">
      <div class="modal-header border-0 pb-0">
        ...
        <a href="/application/cust_customer_list" class="avtar avtar-s btn-link-danger btn-pc-default ms-auto" data-bs-dismiss="modal">
        ...
        <div class="row">
              ...
              <div class="card-body position-relative">
                ...
                <div class="text-center mt-3">
                  <div class="chat-avtar d-inline-flex mx-auto">
                    <img class="rounded-circle img-fluid wid-60" src="/assets/images/user/avatar-5.jpg" alt="img" />
                  </div>
                  ...
                  <div class="d-inline-flex align-items-center justify-content-between w-100">
                    ...
                    <a href="/application/cust_customer_list" class="link-primary">
          ...
          <div class="col-lg-8">
            ...
            <div class="card">
              ...
              <div class="card-body">
                <p class="mb-0"
                  >Hello, I’m Aaron Poole Manufacturing Director based in international company, Void jiidki me na fep juih ced gihhiwi
      ...
      <div class="modal-body">
        <div class="row">
          <div class="col-sm-3 text-center">
            <div class="chat-avtar d-inline-flex mx-auto">
              <img class="rounded-circle img-fluid wid-70" src="/assets/images/user/avatar-5.jpg" alt="img" />
            </div>
          </div>
          <div class="col-sm-9">
            <div class="mb-3">
            ...
            <div class="form-check form-switch d-flex align-items-center justify-content-between p-0">
              <label class="form-check-label h5 pe-3 mb-0" for="customSwitchemlnot1"
                >Make Contact Info Public
                <span class="text-muted w-75 d-block text-sm f-w-400 mt-2"
                  >Means that anyone viewing your profile will be able to see your contacts details</span
                >
              </label>
            ...
            <hr class="my-3 border border-secondary-subtle" />
            <div class="form-check form-switch d-flex align-items-center justify-content-between p-0">
              <label class="form-check-label h5 pe-3 mb-0" for="customSwitchemlnot2"
                >Available to hire
                <span class="text-muted w-75 d-block text-sm f-w-400 mt-2"
                  >Toggling this will let your teammates know that you are available for acquiring new projects</span
                >
              </label>
