...
<div class="pc-container">
  <div class="pc-content">
    <Breadcrumb item="E-commerce" itemActive="Checkout" />
    <!-- [ Main Content ] start -->
    <div class="row">
      <!-- [ sample-page ] start -->
      <div class="col-sm-12">
          ...
          <div class="tab-pane show active" id="ecomtab-1" role="tabpanel" aria-labelledby="ecomtab-tab-1">
            <div class="row">
              <div class="col-xl-8">
                      ...
                      <table class="table mb-0" id="pc-dt-simple">
                        ...
                        <tbody>
                          <tr>
                            <td>
                              <div class="d-flex align-items-center">
                                <img src="/assets/images/application/img-prod-2.jpg" alt="img" class="bg-light wid-50 rounded" />
                            ...
                            <td class="text-center">
                              <div class="btn-group btn-group-sm mb-2 border" role="group">
                                <button type="button" on:click={() => decreaseValue('number')} class="btn btn-link-secondary"
                                ...
                                <input
                                  ...
                                  value="0"
                                />
                                <button type="button" on:click={() => increaseValue('number')} class="btn btn-link-secondary"
                            ...
                            <td class="text-end">
                              <a href="/application/ecom_checkout" class="avtar avtar-s btn-link-danger btn-pc-default">
                          ...
                          <tr>
                            <td>
                              <div class="d-flex align-items-center">
                                <img src="/assets/images/application/img-prod-3.jpg" alt="img" class="bg-light wid-50 rounded" />
                                <div class="flex-grow-1 ms-3">
                                  <h5 class="mb-1">Apple MacBook Pro</h5>
                                  <p class="text-sm text-muted mb-0">Dark Red</p>
                                </div>
                            ...
                            <td class="text-center">
                              <div class="btn-group btn-group-sm mb-2 border" role="group">
                                <button type="button" on:click={() => decreaseValue('number2')} class="btn btn-link-secondary"
                                  ><i class="ti ti-minus"></i></button
                                >
                                <input
                                  class="wid-35 text-center border-0 m-0 form-control rounded-0 shadow-none"
                                  ...
                                  value="0"
                                />
                                <button type="button" on:click={() => increaseValue('number2')} class="btn btn-link-secondary"
                                  ><i class="ti ti-plus"></i></button
                                >
                              </div>
                            </td>
                          ...
                          <tr>
                            <td>
                              <div class="d-flex align-items-center">
                                <img src="/assets/images/application/img-prod-4.jpg" alt="img" class="bg-light wid-50 rounded" />
                                <div class="flex-grow-1 ms-3">
                                  <h5 class="mb-1">Apple MacBook Pro</h5>
                                  <p class="text-sm text-muted mb-0">Dark Red</p>
                                </div>
                            ...
                            <td class="text-center">
                              <div class="btn-group btn-group-sm mb-2 border" role="group">
                                <button type="button" on:click={() => decreaseValue('number1')} class="btn btn-link-secondary"
                                  ><i class="ti ti-minus"></i></button
                                >
                                <input
                                  class="wid-35 text-center border-0 m-0 form-control rounded-0 shadow-none"
                                  ...
                                  value="0"
                                />
                                <button type="button" on:click={() => increaseValue('number1')} class="btn btn-link-secondary"
                                  ><i class="ti ti-plus"></i></button
                                >
                              </div>
                            </td>
                ...
                <div class="text-end">
                  <a href="../application/ecom_product.html" class="btn btn-link-secondary d-inline-flex align-items-center"
                    ><i class="ti ti-chevron-left me-2"></i> Back to Shopping</a
                  >
                </div>
              </div>
              <div class="col-xl-4">
                ...
                <div class="card">
                  <div class="card-body py-2">
                    <ul class="list-group list-group-flush">
                      ...
                      <li class="list-group-item px-0">
                        <div class="float-end"> <h5 class="mb-0">$300.00</h5> </div><span class="text-muted">Sub Total</span>
                      </li>
                      <li class="list-group-item px-0">
                        <div class="float-end"> <h5 class="mb-0">-</h5> </div><span class="text-muted">Estimated Delivery</span>
                      </li>
                      <li class="list-group-item px-0">
                        <div class="float-end"> <h5 class="mb-0">-</h5> </div><span class="text-muted">Voucher</span>
                      </li>
                    </ul>
                  </div>
                </div>
                              ...
                              <span class="row align-items-center justify-content-between">
                                ...
                                <span class="col-sm-6 text-sm-end">
                                  <span class="address-btns d-flex align-items-center justify-content-end">
                                    <a href="/application/ecom_checkout" class="avtar avtar-s btn-link-danger btn-pc-default me-1">
                        ...
                        <div class="col-12">
                          <div class="mb-3 row">
                            <label class="col-lg-4 col-form-label"
                              >Address Type :<small class="text-muted d-block">Enter Add Type</small></label
                            >
                            <div class="col-lg-8">
                          ...
                          <div class="mb-3 row">
                            <label class="col-lg-4 col-form-label"
                              >Last Name :<small class="text-muted d-block">Enter your last name</small></label
                            >
                            <div class="col-lg-8">
                              <input type="text" class="form-control" />
                            </div>
                          ...
                          <div class="text-end btn-page mb-0 mt-4">
                            ...
                            >
                            <button class="btn btn-primary" on:click={() => change_tab('#ecomtab-3')}>Save & Deliver to this Address</button
                            >
                          </div>
                        </div>
                      </div>
                      ...
                      <li class="list-group-item">
                        <div class="d-flex align-items-start">
                          ...
                          <div class="flex-grow-1 mx-2">
                            ...
                            <h5 class="mb-1"
                              ><b>$275</b><span class="mx-2 text-sm text-decoration-line-through text-muted f-w-400">$325</span></h5
                            >
                          </div>
                          <a href="/application/ecom_checkout" class="avtar avtar-s btn-link-danger btn-pc-default flex-shrink-0">
                            <i class="ti ti-trash f-20"></i>
                          </a>
                        </div>
                      </li>
                ...
                <div class="col-xl-8">
                    ...
                    <div class="card-body">
                          ...
                          <label class="form-check-label d-block">
                            <span class="row align-items-center justify-content-between">
                              ...
                              <span class="col-6 text-end">
                                <button class="btn btn-primary" on:click={change_tab('#ecomtab-2')}
                                  ><i class="ti ti-edit-circle align-text-bottom me-1"></i>Change</button
                                >
                              </span>
                            </span>
                            <span class="text-muted address-details"
                      ...
                      <div class="row g-2">
                        <div class="col-md-6">
                          <div class="address-check border rounded">
                            <div class="form-check paycard" style="background-image: url(../assets/images/application/img-pay-card-bg.png)">
                      ...
                      <div class="row">
                        <div class="col-12 mt-2">
                          <div class="mb-3 row">
                            <label class="col-lg-4 col-form-label"
                              >Card Number :<small class="text-muted d-block">Enter the 16 digit card number on the card</small></label
                            >
                            <div class="col-lg-8">
                              <input type="text" class="form-control" />
                            </div>
                          ...
                          <div class="mb-3 row">
                            <label class="col-lg-4 col-form-label"
                              >Expiry Date :<small class="text-muted d-block">Enter the expiration on the card</small></label
                            >
                            <div class="col-lg-8">
                              <div class="row">
                                <div class="col-6">
                          ...
                          <div class="mb-3 row">
                            <label class="col-lg-4 col-form-label"
                              >CVV Number :<small class="text-muted d-block">Enter the 3 or 4 digit number on the card</small></label
                            >
                            <div class="col-lg-8">
                              <input type="text" class="form-control" />
                            </div>
                          ...
                          <div class="mb-3 row">
                            <label class="col-lg-4 col-form-label"
                              >Password :<small class="text-muted d-block">Enter your dynamic password</small></label
                            >
                            <div class="col-lg-8">
                  ...
                  <div class="d-flex justify-content-end mb-3">
                    <button class="btn btn-link-primary"
                      ><i class="ti ti-arrow-narrow-left align-text-bottom me-2"></i>Back to Shipping Information</button
                    >
                  </div>
                </div>
                <div class="col-xl-4">
                        ...
                        <li class="list-group-item">
                          <div class="d-flex align-items-start">
                            ...
                            <div class="flex-grow-1 mx-2">
                              ...
                              <p class="text-muted text-sm mb-2">SLR Camera (Black) with EF</p>
                              <h5 class="mb-1"
                                ><b>$275</b><span class="mx-2 text-sm text-decoration-line-through text-muted f-w-400">$325</span>
                              </h5>
                            </div>
                            <a href="/application/ecom_checkout" class="avtar avtar-s btn-link-danger btn-pc-default flex-shrink-0">
                              <i class="ti ti-trash f-20"></i>
  ...
  <div class="modal-dialog modal-lg modal-dialog-centered">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <a href="/application/ecom_checkout" class="avtar avtar-s btn-link-danger btn-pc-default" data-bs-dismiss="modal">
            ...
            <div class="card my-2 coupon-card bg-warning small-coupon-card">
              <div class="card-body py-2">
                <div class="d-flex align-items-center justify-content-between">
                  ...
                  <img src="/assets/images/application/img-coupon-1.png" alt="img" class="img-fluid" />
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="card my-2 coupon-card bg-success small-coupon-card">
              <div class="card-body py-2">
                <div class="d-flex align-items-center justify-content-between">
                  ...
                  <img src="/assets/images/application/img-coupon-2.png" alt="img" class="img-fluid" />
                </div>
              </div>
            </div>
          </div>
