<script>
  ...
  import Uppy from '@uppy/core?client';
  import Tus from '@uppy/tus?client';
  import DragDrop from '@uppy/drag-drop?client';
  import ProgressBar from '@uppy/progress-bar?client';
  ...
  onMount(() => {
    ...
    const fileDescActions = document.querySelectorAll('.file-card .form-check-label, .file-card td:nth-child(2)');

    fileDescActions.forEach((action) => {
...
<div class="pc-container">
  <div class="pc-content">
    <Breadcrumb item="Application" itemActive="File Manager" />
    <!-- [ Main Content ] start -->
    <div class="row">
      <!-- [ sample-page ] start -->
                ...
                <div class="card-body">
                  <div class="d-flex">
                    ...
                    <div class="flex-grow-1 mx-3">
                      <h5 class="mb-1 d-grid">
                        <span class="text-truncate w-100">Documents</span>
                      </h5>
                    ...
                    <div class="dropdown">
                      <a
                        ...
                        href="/application/file-manager"
                        data-bs-toggle="dropdown"
                        aria-haspopup="true"
                        aria-expanded="false"><i class="material-icons-two-tone f-18">more_vert</i></a
                      >
                      <div class="dropdown-menu dropdown-menu-end">
                        <a class="dropdown-item" href="/application/file-manager">Edit</a>
                        <a class="dropdown-item" href="/application/file-manager">Delete</a>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div class="card">
                <div class="card-body">
                  <div class="d-flex">
                    ...
                    <div class="flex-grow-1 mx-3">
                      <h5 class="mb-1 d-grid">
                        <span class="text-truncate w-100">Music and video</span>
                      </h5>
                      <p class="mb-0"><small>100 files</small></p>
                    </div>
                    <div class="dropdown">
        ...
        <div class="row my-3">
          <div class="col">
            <div class="d-flex align-items-center">
              ...
              <a
                href="/application/file-manager"
                class="avtar avtar-xs btn btn-primary rounded-circle p-0"
                ...
                <div class="card file-card">
                  <div class="card-body">
                    ...
                    <div class="my-3 text-center">
                      <img src="/assets/images/application/img-file-doc.svg" alt="img" class="img-fluid" />
                    </div>
                    <div class="d-flex align-items-center justify-content-between mt-4">
                      <div>
                        <h6 class="mb-0">
                          <span class="text-truncate w-100">Document-final.docx</span>
                        </h6>
              ...
              <div class="col-md-6 col-lg-4 col-xxl-3">
                <div class="card file-card">
                  <div class="card-body">
                    ...
                    <div class="my-3 text-center">
                      <img src="/assets/images/application/img-file-xls.svg" alt="img" class="img-fluid" />
                    </div>
                    <div class="d-flex align-items-center justify-content-between mt-4">
                      <div>
                        <h6 class="mb-0">
                ...
                <div class="card file-card">
                  <div class="card-body">
                    ...
                    <div class="d-flex align-items-center justify-content-between mt-4">
                      ...
                      <a href="/application/file-manager" class="user-popup" data-bs-toggle="modal" data-bs-target="#assignFile">
                        <div class="user-group p-1">
                          <img src="/assets/images/user/avatar-1.jpg" alt="img" class="avtar" />
                          <img src="/assets/images/user/avatar-2.jpg" alt="img" class="avtar" />
                          <img src="/assets/images/user/avatar-3.jpg" alt="img" class="avtar" />
                        </div>
                      </a>
                    </div>
                  </div>
              ...
              <div class="col-md-6 col-lg-4 col-xxl-3">
                <div class="card file-card">
                  <div class="card-body">
                    ...
                    <div class="my-3 text-center">
                      <img src="/assets/images/application/img-file-rar.svg" alt="img" class="img-fluid" />
                    </div>
                    <div class="d-flex align-items-center justify-content-between mt-4">
                      <div>
                        <h6 class="mb-0">
                ...
                <div class="card file-card">
                  <div class="card-body">
                    ...
                    <div class="my-2 text-center">
                      <img src="/assets/images/application/img-file-imgview.jpg" alt="img" class="img-fluid rounded" />
                    </div>
                    <div class="d-flex align-items-center justify-content-between">
                      <div>
                        <h6 class="mb-0">
              ...
              <div class="col-md-6 col-lg-4 col-xxl-3">
                <div class="card file-card">
                  <div class="card-body">
                    ...
                    <div class="my-3 text-center">
                      <img src="/assets/images/application/img-file-ppt.svg" alt="img" class="img-fluid" />
                    </div>
                    <div class="d-flex align-items-center justify-content-between mt-4">
                      <div>
                        <h6 class="mb-0">
              ...
              <div class="col-md-6 col-lg-4 col-xxl-3">
                <div class="card file-card">
                  <div class="card-body">
                    ...
                    <div class="my-3 text-center">
                      <img src="/assets/images/application/img-file-ai.svg" alt="img" class="img-fluid" />
                    </div>
                    <div class="d-flex align-items-center justify-content-between mt-4">
                      <div>
                        <h6 class="mb-0">
              ...
              <div class="col-md-6 col-lg-4 col-xxl-3">
                <div class="card file-card">
                  <div class="card-body">
                    ...
                    <div class="my-3 text-center">
                      <img src="/assets/images/application/img-file-txt.svg" alt="img" class="img-fluid" />
                    </div>
                    <div class="d-flex align-items-center justify-content-between mt-4">
                      <div>
                        <h6 class="mb-0">
              ...
              <div class="col-md-6 col-lg-4 col-xxl-3">
                <div class="card file-card">
                  <div class="card-body">
                    ...
                    <div class="my-3 text-center">
                      <img src="/assets/images/application/img-file-img.svg" alt="img" class="img-fluid" />
                    </div>
                    <div class="d-flex align-items-center justify-content-between mt-4">
                      <div>
                        <h6 class="mb-0">
              ...
              <table class="table table-borderless file-card">
                <tbody>
                  <tr>
                    ...
                    <td>
                      <div class="d-flex align-items-center">
                        <img src="/assets/images/application/img-file-doc.svg" alt="img" class="wid-35" />
                  ...
                  <tr>
                    ...
                    <td>
                      <div class="d-flex align-items-center">
                        <img src="/assets/images/application/img-file-xls.svg" alt="img" class="wid-35" />
                  ...
                  <tr>
                    ...
                    <td>
                      <div class="d-flex align-items-center">
                        <img src="/assets/images/application/img-file-pdf.svg" alt="img" class="wid-35" />
                        <h6 class="mb-0 ms-2 text-truncate">Document-final.docx</h6>
                      </div>
                    </td>
                    <td>16.3 MB</td>
                    ...
                    <td>
                      <div class="user-group p-1">
                        <img src="/assets/images/user/avatar-1.jpg" alt="img" class="avtar" />
                        <img src="/assets/images/user/avatar-2.jpg" alt="img" class="avtar" />
                        <img src="/assets/images/user/avatar-5.jpg" alt="img" class="avtar" />
                        <img src="/assets/images/user/avatar-3.jpg" alt="img" class="avtar" />
                        <span class="avtar avtar-xs bg-light-primary text-primary">+2</span>
                      </div>
                    </td>
                  ...
                  <tr>
                    ...
                    <td>
                      <div class="d-flex align-items-center">
                        <img src="/assets/images/application/img-file-ai.svg" alt="img" class="wid-35" />
                        <h6 class="mb-0 ms-2 text-truncate">Document-final.docx</h6>
                      </div>
                    </td>
                    <td>16.3 MB</td>
                  ...
                  <tr>
                    ...
                    <td>
                      <div class="d-flex align-items-center">
                        <img src="/assets/images/application/img-file-img.svg" alt="img" class="wid-35" />
                        <h6 class="mb-0 ms-2 text-truncate">ablepro-design.sketch</h6>
                      </div>
                    </td>
                    <td>16.3 MB</td>
                  ...
                  <tr>
                    ...
                    <td>
                      <div class="d-flex align-items-center">
                        <img src="/assets/images/application/img-file-ppt.svg" alt="img" class="wid-35" />
                        <h6 class="mb-0 ms-2 text-truncate">Document-final.docx</h6>
                      </div>
                    </td>
                    <td>16.3 MB</td>
                  ...
                  <tr>
                    ...
                    <td>
                      <div class="d-flex align-items-center">
                        <img src="/assets/images/application/img-file-txt.svg" alt="img" class="wid-35" />
                        <h6 class="mb-0 ms-2 text-truncate">ablepro-design.sketch</h6>
                      </div>
                    </td>
                    <td>16.3 MB</td>
                  ...
                  <tr>
                    ...
                    <td>
                      <div class="d-flex align-items-center">
                        <img src="/assets/images/application/img-file-rar.svg" alt="img" class="wid-35" />
                        <h6 class="mb-0 ms-2 text-truncate">Document-final.docx</h6>
                      </div>
                    </td>
                    <td>16.3 MB</td>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div class="d-flex align-items-center my-3">
          <img class="rounded-circle img-fluid wid-40" src="/assets/images/user/avatar-2.jpg" alt="img" />
        ...
        <div class="d-flex align-items-center my-3">
          <img class="rounded-circle img-fluid wid-40" src="/assets/images/user/avatar-5.jpg" alt="img" />
          <div class="flex-grow-1 mx-2">
        ...
        <div class="d-flex align-items-center my-3">
          <img class="rounded-circle img-fluid wid-40" src="/assets/images/user/avatar-3.jpg" alt="img" />
          <div class="flex-grow-1 mx-2">
...
<div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasFileDesc">
  <div class="offcanvas-header">
    ...
    <a href="/application/file-manager" class="avtar avtar-s btn-link-danger btn-pc-default ms-auto" data-bs-dismiss="offcanvas">
  ...
  <div class="offcanvas-body">
    ...
    <ul class="list-group list-group-flush">
      <li class="list-group-item">
        <div class="d-flex align-items-center">
          <img class="rounded-circle img-fluid wid-40" src="/assets/images/user/avatar-1.jpg" alt="img" />
          <div class="flex-grow-1 ms-2">
            <h6 class="mb-0">John Doe</h6>
            <p class="mb-0 text-sm">
              <a class="link-secondary" href="mailto:John_Doe@ablepro.io">John_Doe@ablepro.io</a>
            </p>
          </div>
        </div>
      </li>
      <li class="list-group-item">
        <div class="d-flex align-items-center">
          ...
          <div class="flex-grow-1 ms-2">
            ...
            <p class="mb-0 text-sm">
              <a class="link-secondary" href="mailto:Addie_B@ablepro.io">Addie_B@ablepro.io</a>
            </p>
          </div>
        </div>
      </li>
      <li class="list-group-item">
        <div class="d-flex align-items-center">
          ...
          <div class="flex-grow-1 ms-2">
            ...
            <p class="mb-0 text-sm">
              <a class="link-secondary" href="mailto:Alberta@ablepro.io">Alberta@ablepro.io</a>
            </p>
          </div>
        </div>
      </li>
      <li class="list-group-item">
        <div class="d-flex align-items-center">
          <img class="rounded-circle img-fluid wid-40" src="/assets/images/user/avatar-4.jpg" alt="img" />
          <div class="flex-grow-1 ms-2">
            <h6 class="mb-0">Agnes McGee</h6>
            <p class="mb-0 text-sm">
              <a class="link-secondary" href="mailto:Agnes.Gee@ablepro.io">Agnes.Gee@ablepro.io</a>
            </p>
          </div>
        </div>
      </li>
