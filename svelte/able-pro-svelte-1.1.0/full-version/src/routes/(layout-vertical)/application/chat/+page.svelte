              ...
              <div id="chat-user_list" class="show collapse collapse-horizontal">
                <div class="chat-user_list">
                  <div class="card overflow-hidden">
                    ...
                    <div class="scroll-block">
                      <div class="card-body p-0">
                        <div class="list-group list-group-flush">
                          <a href="/application/chat" class="list-group-item list-group-item-action p-3">
                    ...
                    <div class="card-body p-0">
                      <div class="list-group list-group-flush">
                        <a href="/application/chat" class="list-group-item list-group-item-action">
                          ...
                          <div class="d-flex align-items-center">
                            ...
                            <div class="dropdown">
                              ...
                              <div class="dropdown-menu dropdown-menu-end">
                                <a class="dropdown-item" href="/application/chat"><i class="chat-badge bg-success"></i> Active</a>
                                <a class="dropdown-item" href="/application/chat"><i class="chat-badge bg-warning"></i> Away</a>
                                <a class="dropdown-item" href="/application/chat"
                                  ><i class="chat-badge bg-secondary"></i> Edit Do not disturb</a
                                >
                              </div>
                            </div>
                          </div>
            ...
            <div class="card mb-0">
              <div class="card-header p-3">
                <div class="d-flex align-items-center">
                  ...
                  <ul class="list-inline ms-auto mb-0">
                    <li class="list-inline-item">
                      <a href="/application/chat" class="avtar avtar-s btn-link-secondary">
                    ...
                    <li class="list-inline-item">
                      <div class="dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-end">
                          <a class="dropdown-item" href="/application/chat">Name</a>
                          <a class="dropdown-item" href="/application/chat">Date</a>
                          <a class="dropdown-item" href="/application/chat">Ratting</a>
                          <a class="dropdown-item" href="/application/chat">Unread</a>
                        </div>
                      </div>
                    </li>
                  </ul>
                              ...
                              <li class="list-inline-item">
                                <div class="dropdown">
                                  ...
                                  <div class="dropdown-menu">
                                    <a class="dropdown-item" href="/application/chat"><i class="ti ti-arrow-back-up"></i> Reply</a>
                                    <a class="dropdown-item" href="/application/chat"><i class="ti ti-arrow-forward-up"></i> Forward</a>
                                    <a class="dropdown-item" href="/application/chat"><i class="ti ti-copy"></i> Copy</a>
                                    <a class="dropdown-item" href="/application/chat"><i class="ti ti-trash"></i> Delete</a>
                                  </div>
                                </div>
                              </li>
                              <li class="list-inline-item">
                                <a href="/application/chat" class="avtar avtar-xs btn-link-secondary">
              ...
              <div class="card-footer py-2 px-3">
                ...
                <div class="d-sm-flex align-items-center">
                  ...
                  <ul class="list-inline ms-auto mb-0">
                    <li class="list-inline-item">
                      <a href="/application/chat" class="avtar avtar-s btn-link-primary">
                  ...
                  <div class="card">
                    <div class="text-center card-body position-relative pb-0">
                      ...
                      <div class="chat-avtar d-inline-flex mx-auto">
                        <img class="rounded-circle img-fluid wid-100" src="/assets/images/user/avatar-5.jpg" alt="img" />
                      </div>
                        ...
                        <div class="collapse show" id="filtercollapse2">
                          <div class="py-3">
                            <div class="d-flex align-items-center mb-2">
                              <a href="/application/chat" class="avtar avtar-s btn-light-success">
                            ...
                            <div class="d-flex align-items-center mb-2">
                              <a href="/application/chat" class="avtar avtar-s btn-light-warning">
                            ...
                            <div class="d-flex align-items-center mb-2">
                              <a href="/application/chat" class="avtar avtar-s btn-light-primary">
