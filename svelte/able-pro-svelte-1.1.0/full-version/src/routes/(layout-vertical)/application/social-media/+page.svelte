...
<svelte:head>
  <title>Social Media | Able Pro Dashboard Template</title>
</svelte:head>
<!-- [ Main Content ] start -->
<div class="pc-container">
  <div class="pc-content">
    <Breadcrumb item="Application" itemActive="Social Media" />
    <!-- [ Main Content ] start -->
    <div class="row">
      <!-- [ sample-page ] start -->
      <div class="col-sm-12">
          ...
          <div class="card-body pt-0">
            <div class="row align-items-end">
              <div class="col-md-auto text-md-start">
                <img class="img-fluid img-profile-avtar" src="/assets/images/user/avatar-5.jpg" alt="img" />
              </div>
              <div class="col">
              ...
              <div class="tab-pane show active" id="profile" role="tabpanel">
                      ...
                      <div class="col">
                        <ul class="list-inline ms-auto mb-0">
                          <li class="list-inline-item border-end pe-2 me-2">
                            <a href="/application/social-media" class="avtar avtar-s btn-link-warning">
                              <i class="ti ti-mood-smile f-18"></i>
                            </a>
                          </li>
                          <li class="list-inline-item">
                            <a href="/application/social-media" class="avtar avtar-s btn-link-secondary">
                ...
                <div class="card">
                  <div class="card-body">
                    <div class="d-flex align-items-center mb-3">
                      ...
                      <div class="dropdown">
                        <a
                          ...
                          href="/application/social-media"
                          data-bs-toggle="dropdown"
                          aria-haspopup="true"
                          aria-expanded="false"><i class="material-icons-two-tone f-18">more_vert</i></a
                        >
                        <div class="dropdown-menu dropdown-menu-end">
                          <a class="dropdown-item" href="/application/social-media">Edit</a>
                          <a class="dropdown-item" href="/application/social-media">Delete</a>
                        </div>
                      </div>
                    </div>
                    <p class="my-4"
                    ...
                    <div class="row g-2">
                      <div class="col-md-6">
                        <a class="img-post card" data-lightbox="/assets/images/application/img-post-1.jpg">
                    ...
                    <div class="row my-4">
                      <div class="col">
                        <a href="/application/social-media" class="btn btn-link-dark">
                          <i class="material-icons-two-tone me-1">thumb_up_alt</i> 450K <small class="text-muted">Likes</small></a
                        >
                        <a href="/application/social-media" class="btn btn-link-secondary">
                      ...
                      <div class="col-auto text-end">
                        <div class="d-flex align-items-center">
                          ...
                          <div class="user-group post-user-group">
                            ...
                            <img src="/assets/images/user/avatar-4.jpg" alt="img" class="avtar" />
                    ...
                    <div class="comment-block">
                      <div class="comment">
                        ...
                        <div class="comment-content">
                          ...
                          >
                          <a href="/application/social-media" class="link-primary mb-1">https://phoenixcoded.net/</a>
                        </div>
                      </div>
                      <div class="comment-content">
                        <div class="mb-4">
                          ...
                          >
                          <a href="/application/social-media" class="btn btn-link-secondary">
                            <i class="material-icons-two-tone me-1">share</i>100</a
                          >
                        </div>
                      </div>
                    ...
                    <div class="d-flex align-items-center mt-3">
                      ...
                      <div class="flex-grow-1 me-3">
                        <div class="input-comment">
                          ...
                          <ul class="list-inline start-0 mb-0">
                            <li class="list-inline-item border-end pe-2 me-2">
                              <a href="/application/social-media" class="avtar avtar-xs btn-link-warning">
                                <i class="ti ti-mood-smile f-18"></i>
                              </a>
                            </li>
                          </ul>
                          <ul class="list-inline end-0 mb-0">
                            <li class="list-inline-item">
                              <a href="/application/social-media" class="avtar avtar-xs btn-link-secondary">
                                <i class="ti ti-photo f-18"></i>
                              </a>
                            </li>
                            <li class="list-inline-item">
                      ...
                      <a href="/application/social-media" class="avtar avtar-s btn btn-primary">
              ...
              <div class="tab-pane" id="followers" role="tabpanel" aria-labelledby="followers-tab">
                <div class="card">
                  ...
                  <ul class="list-group list-group-flush">
                    ...
                    <li class="list-group-item">
                      <div class="d-flex align-items-center">
                        <img class="rounded-circle img-fluid wid-40" src="/assets/images/user/avatar-6.jpg" alt="img" />
                        <div class="flex-grow-1 mx-2">
                          <h6 class="mb-0">John Doe</h6>
                          <p class="mb-0">@John_Doe</p>
                        </div>
                    ...
                    <li class="list-group-item">
                      <div class="d-flex align-items-center">
                        <img class="rounded-circle img-fluid wid-40" src="/assets/images/user/avatar-7.jpg" alt="img" />
                        <div class="flex-grow-1 mx-2">
                          <h6 class="mb-0">Addie Bass</h6>
                          <p class="mb-0">@A_Bass</p>
                        </div>
                    ...
                    <li class="list-group-item">
                      <div class="d-flex align-items-center">
                        <img class="rounded-circle img-fluid wid-40" src="/assets/images/user/avatar-8.jpg" alt="img" />
                        <div class="flex-grow-1 mx-2">
                          <h6 class="mb-0">Alberta Robbins</h6>
                          <p class="mb-0">@AlbeRob12</p>
                        </div>
                    ...
                    <li class="list-group-item">
                      <div class="d-flex align-items-center">
                        <img class="rounded-circle img-fluid wid-40" src="/assets/images/user/avatar-9.jpg" alt="img" />
                        <div class="flex-grow-1 mx-2">
                          <h6 class="mb-0">Agnes McGee</h6>
                          <p class="mb-0">@AgnMcGee</p>
                        </div>
                    ...
                    <li class="list-group-item">
                      <div class="d-flex align-items-center">
                        <img class="rounded-circle img-fluid wid-40" src="/assets/images/user/avatar-10.jpg" alt="img" />
                        <div class="flex-grow-1 mx-2">
                          <h6 class="mb-0">Lilla Bardenova</h6>
                          <p class="mb-0">@lillabardenova</p>
                        </div>
            ...
            <div class="card">
              ...
              <div class="card-body">
                ...
                <ul class="list-unstyled mb-0">
                  ...
                  <li>
                    <a class="d-flex align-items-center text-muted text-hover-primary mb-2" href="mailto:demo123@mail.com" target="_blank">
                      <div class="avtar avtar-xs bg-light-secondary flex-shrink-0 me-2">
                  ...
                  <div class="d-flex align-items-center">
                    ...
                    <div class="dropdown">
                      <a
                        ...
                        data-bs-toggle="dropdown"
                        aria-haspopup="true"
                        aria-expanded="false"><i class="material-icons-two-tone f-18">more_horiz</i></a
                      >
                      <div class="dropdown-menu dropdown-menu-end">
                        <a class="dropdown-item" href="/application/social-media">Edit</a>
                        <a class="dropdown-item" href="/application/social-media">Delete</a>
            ...
            <div class="card">
              ...
              <div class="card-body">
                <div
                  ...
                  style="background-image: url(../assets/images/application/img-event-bg.jpg)"
                >
                  <div class="card-body">
