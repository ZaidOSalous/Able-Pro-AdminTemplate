...
<div class="pc-container">
  <div class="pc-content">
    <Breadcrumb item="E-commerce" itemActive="Products" />
    <!-- [ Main Content ] start -->
    <div class="row">
      <!-- [ sample-page ] start -->
      <div class="col-sm-12">
              ...
              <div id="ecom-filter" class="show collapse collapse-horizontal">
                <div class="ecom-filter">
                  <div class="card">
                    ...
                    <div class="scroll-block" use:simplebar>
                      <div class="card-body">
                        <ul class="list-group list-group-flush">
                          ...
                          <li class="list-group-item px-0 py-2">
                            <a href="/application/ecom_product" class="btn btn-light-danger w-100">Clear All</a>
                          </li>
                        </ul>
                      </div>
                    </div>
            ...
            <div class="row">
              ...
              <div class="col-sm-6 col-xl-4">
                <div class="card product-card">
                  <div class="card-img-top">
                    <a href="/application/ecom_product-details">
                      <img src="/assets/images/application/img-prod-5.jpg" alt="img" class="img-prod img-fluid" />
                    </a>
                    <div class="card-body position-absolute end-0 top-0">
                      <div class="form-check prod-likes">
                        <input type="checkbox" class="form-check-input" />
              ...
              <div class="col-sm-6 col-xl-4">
                <div class="card product-card">
                  <div class="card-img-top">
                    <a href="/application/ecom_product-details">
                      <img src="/assets/images/application/img-prod-6.jpg" alt="img" class="img-prod img-fluid" />
                    </a>
                    <div class="card-body position-absolute end-0 top-0">
                      <div class="form-check prod-likes">
                        <input type="checkbox" class="form-check-input" />
              ...
              <div class="col-sm-6 col-xl-4">
                <div class="card product-card">
                  <div class="card-img-top">
                    <a href="/application/ecom_product-details">
                      <img src="/assets/images/application/img-prod-7.jpg" alt="img" class="img-prod img-fluid" />
                    </a>
                    <div class="card-body position-absolute end-0 top-0">
                      <div class="form-check prod-likes">
                        <input type="checkbox" class="form-check-input" checked />
              ...
              <div class="col-sm-6 col-xl-4">
                <div class="card product-card">
                  <div class="card-img-top">
                    <a href="/application/ecom_product-details">
                      <img src="/assets/images/application/img-prod-8.jpg" alt="img" class="img-prod img-fluid" />
                    </a>
                    <div class="card-body position-absolute end-0 top-0">
                      <div class="form-check prod-likes">
                        <input type="checkbox" class="form-check-input" checked />
