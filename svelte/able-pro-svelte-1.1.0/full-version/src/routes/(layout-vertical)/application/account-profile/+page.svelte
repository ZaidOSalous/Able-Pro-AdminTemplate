...
<div class="pc-container">
  <div class="pc-content">
    <Breadcrumb item="Users" itemActive="Account Profile" />
    <!-- [ Main Content ] start -->
    <div class="row">
      <!-- [ sample-page ] start -->
      <div class="col-sm-12">
                  ...
                  <div class="card-body position-relative">
                    ...
                    <div class="text-center mt-3">
                      ...
                      <div class="d-inline-flex align-items-center justify-content-start w-100">
                        ...
                        <a href="/application/account-profile" class="link-primary">
                      ...
                      <div class="col-sm-12">
                        <div class="mb-3">
                          ...
                          <textarea class="form-control">
                            ...
                            digital Products a more Beautiful and usable place. Morbid accusant ipsum. Nam nec tellus at.</textarea
                          >
                        </div>
                      </div>
                      <div class="col-sm-12">
                    ...
                    <div class="d-flex align-items-center mb-2">
                      <div class="flex-grow-1 me-3">
                        <div class="d-flex align-items-center">
                          ...
                          <div class="flex-grow-1 ms-3">
                            <h6 class="mb-0">
                              Facebook <small class="text-muted f-w-400">/Anshan Handgun</small>
                            </h6>
                          </div>
                        </div>
                      </div>
                      ...
                      <li class="list-group-item px-0 pt-0">
                        <div class="d-flex align-items-center justify-content-between">
                          ...
                          <div class="form-check form-switch p-0">
                            <input class="form-check-input h4 position-relative m-0" type="checkbox" role="switch" checked="true" />
                          </div>
                        </div>
                      </li>
                      <li class="list-group-item px-0">
                ...
                <div class="row">
                  ...
                  <div class="col-sm-6">
                    ...
                    <ul class="list-group list-group-flush">
                      ...
                      <li class="list-group-item">
                        <i class="ti ti-circle-check text-success f-16 me-2"></i> At least 1 uppercase letter(A-Z)
                      </li>
                      <li class="list-group-item">
                  ...
                  <table class="table mb-0">
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td class="text-end"
                          ><a href="/application/account-profile" class="avtar avtar-s btn-link-secondary"
                            ><i class="ti ti-dots f-18"></i></a
                          ></td
                        >
                      </tr>
                      <tr>
                        ...
                        <td class="text-end"
                          ><a href="/application/account-profile" class="btn btn-link-danger">Resend</a>
                ...
                <div class="card">
                  ...
                  <div class="card-body">
                    ...
                    <div class="d-flex align-items-center justify-content-between mb-1">
                      ...
                      <div class="form-check form-switch p-0">
                        <input class="m-0 form-check-input h5 position-relative" type="checkbox" role="switch" checked="true" />
                      </div>
                    </div>
                    <div class="d-flex align-items-center justify-content-between mb-1">
                      <div>
