...
<svelte:head>
  <title>Detail Invoice | Able Pro Dashboard Template</title>
</svelte:head>
<!-- [ Main Content ] start -->
<div class="pc-container">
  <div class="pc-content">
    <Breadcrumb item="Invoice" itemActive="Detail" />
    <!-- [ Main Content ] start -->
    <div class="row">
      <div class="col-sm-12">
        <div class="card">
                ...
                <div class="alert alert-secondary mb-3 d-print-none">
                  <ul class="list-inline ms-auto mb-0 d-flex justify-content-end flex-wrap">
                    <li class="list-inline-item align-bottom me-2">
                      <a href="/application/invoice-view" class="avtar avtar-s btn-link-secondary">
