<script>
  import Simplebar from 'simplebar?client';
  import quill from '$lib/assets/quill.js?client';
  import 'simplebar/dist/simplebar.min.css';
  import 'dragula/dist/dragula.min.css';
  import { onMount } from 'svelte';
  import bootstrap from 'bootstrap/dist/js/bootstrap.js?client';
  let pc_quil_1 = {
    modules: {
      toolbar: [
        [
  ...
  onMount(async () => {
    ...
    var tc1 = document.querySelectorAll('.mail-table tr td:nth-child(2), .mail-table tr td:nth-child(3)');
    for (var t = 0; t < tc1.length; t++) {
      tc1[t].addEventListener('click', function () {
...
<svelte:head>
  <title>Mail | Able Pro Dashboard Template</title>
          ...
          <div class="mail-content">
            <div class="d-sm-flex align-items-center">
              <ul class="list-inline me-auto mb-3">
                ...
                <li class="list-inline-item align-bottom">
                  <a href="/application/mail" class="avtar avtar-s btn-link-secondary" id="toggle-mail-list-height">
                ...
                <li class="list-inline-item">
                  <div class="dropdown">
                    ...
                    <div class="dropdown-menu">
                      <a class="dropdown-item" href="/application/mail">Name</a>
                      <a class="dropdown-item" href="/application/mail">Date</a>
                      <a class="dropdown-item" href="/application/mail">Ratting</a>
                      <a class="dropdown-item" href="/application/mail">Unread</a>
                    </div>
                  </div>
                </li>
              </ul>
              <ul class="list-inline ms-auto mb-3">
                ...
                <li class="list-inline-item">
                  <a href="/application/mail" class="avtar avtar-s btn-link-secondary">
                            ...
                            <table class="table table-borderless mb-0 mail-table">
                              <tbody>
                                <tr class="unread">
                                  ...
                                  <td>
                                    <div class="d-flex align-items-center">
                                      <img src="/assets/images/user/avatar-1.jpg" alt="img" class="img-user rounded-circle" />
                                    ...
                                    <div class="d-flex w-100 align-items-center">
                                      <div class="flex-grow-1 position-relative">
                                        <p class="mb-0 mail-text text-truncate">
                                          ...
                                          the industry's standard dummy text ever since the 1500s.been the industry's standard dummy text
                                ...
                                <tr class="unread">
                                  ...
                                  <td>
                                    <div class="d-flex align-items-center">
                                      <img src="/assets/images/user/avatar-2.jpg" alt="img" class="img-user rounded-circle" />
                                  ...
                                  <td>
                                    <div class="d-flex w-100 align-items-center">
                                      <div class="flex-grow-1 position-relative">
                                        <p class="mb-0 mail-text text-truncate">
                                          of the printing and typesetting industry. Lorem Ipsum has been Lorem Ipsum is simply dummy text
                                          the industry's standard dummy text ever since the 1500s.
                                        </p>
                                      </div>
                                      <div class="mail-content-badge">
                                        <a href="/application/mail" class="badge rounded-pill btn-light-primary py-1 px-2">Promotions</a>
                                        <a href="/application/mail" class="badge rounded-pill btn-light-warning py-1 px-2">Forums</a>
                                      </div>
                                    </div>
                                  </td>
                                  <td>
                                ...
                                <tr class="unread">
                                  ...
                                  <td>
                                    <div class="d-flex align-items-center">
                                      <img src="/assets/images/user/avatar-3.jpg" alt="img" class="img-user rounded-circle" />
                                  ...
                                  <td>
                                    <div class="d-flex w-100 align-items-center">
                                      <div class="flex-grow-1 position-relative">
                                        <p class="mb-0 mail-text text-truncate">
                                          simply dummy text the industry's standard dummy text ever since the 1500s.
                                        </p>
                                      </div>
                                    </div>
                                  </td>
                                ...
                                <tr class="unread">
                                  ...
                                  <td>
                                    <div class="d-flex align-items-center">
                                      <img src="/assets/images/user/avatar-4.jpg" alt="img" class="img-user rounded-circle" />
                                ...
                                <tr>
                                  ...
                                  <td>
                                    <div class="d-flex align-items-center">
                                      <img src="/assets/images/user/avatar-5.jpg" alt="img" class="img-user rounded-circle" />
                                      <h6 class="mb-0 ms-2 text-truncate">Zachary Chambers</h6>
                                    </div>
                                  </td>
                                  <td>
                                ...
                                <div class="d-flex w-100 align-items-center">
                                  <div class="flex-grow-1 position-relative">
                                    <p class="mb-0 mail-text text-truncate">
                                      ...
                                      industry's standard dummy text ever since the 1500s.been the industry's standard dummy text ever since
                                      the 1500s.
                                    </p>
                                  </div>
                                  <div class="mail-content-badge">
                      ...
                      <div class="card-body scroll-block">
                        <div class="row g-0 justify-content-center align-items-center h-100">
                          <div class="col-md-8 col-sm-10 text-center">
                            <img src="/assets/images/application/img-empty-mail.png" alt="img" class="img-fluid mb-4" />
                      ...
                      <div class="card-body scroll-block">
                          ...
                          <div class="card-body p-1">
                            <div class="d-sm-flex align-items-center">
                              <ul class="list-inline me-auto my-2">
                                <li class="list-inline-item align-bottom">
                                  <a href="/application/mail" class="avtar avtar-s btn-link-secondary" id="mail-back_inbox">
                                    <i class="ti ti-chevron-left f-18"></i>
                                  </a>
                                </li>
                                <li class="list-inline-item align-bottom">
                        ...
                        <div class="mail-details">
                          ...
                          <p class="text-muted indent-text">
                            Lorem Ipsum is simply dummy text of the printing and <b>typesetting industry</b>. Lorem Ipsum has been the
                            industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled
                            it to make a type <b>specimen book</b>. It has survived not only five centuries, but also the leap into
                              ...
                              <div class="card bg-body border">
                                <div class="card-body p-3">
                                  <div class="d-flex align-items-center">
                                    ...
                                    <a href="/application/mail" class="avtar avtar-xs btn-link-secondary text-secondary">
                          ...
                          <div class="bg-light rounded p-3 my-3">
                            <div class="d-flex align-items-start mb-3">
                              <img class="rounded-circle img-fluid wid-30" src="/assets/images/user/avatar-4.jpg" alt="img" />
                              <div class="flex-grow-1 ms-3">
                                ...
                                <p class="text-primary">
                                  On Tue, Nov 1, 2022 at 12:05 AM Sreekumar Ks &lt;tazeanu@company.com&gt; wrote:
                                </p>
                          ...
                          <div class="collapse" id="mailreplay">
                            <div class="my-3">
                              <div id="pc-quil-2" style="height: 125px" use:quill={pc_quil_2}>
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <ul class="list-inline me-auto mb-0">
          <li class="list-inline-item align-bottom">
            <a href="/application/mail" class="avtar avtar-s btn-link-secondary" id="toggle_mail_dialog">
              <i class="ti ti-arrows-diagonal-2 f-18"></i>
            </a>
          </li>
          <li class="list-inline-item align-bottom">
            <a href="/application/mail" class="avtar avtar-s btn-link-danger" data-bs-dismiss="modal">
      ...
      <div class="modal-body">
        ...
        <div id="pc-quil-1" style="height: 125px" use:quill={pc_quil_1}>
          <p>Put your things hear...</p>
        </div>
      </div>
