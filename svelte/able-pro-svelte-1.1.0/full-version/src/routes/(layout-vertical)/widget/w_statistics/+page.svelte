...
<div class="pc-container">
  <div class="pc-content">
    <!-- [ breadcrumb ] start -->
    <Breadcrumb item="Widget" itemActive="Statistics" />
            ...
            <div class="d-flex align-items-center justify-content-between mb-3">
              ...
              <div class="dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-end">
                  <a class="dropdown-item" href="/widget/w_statistics">Today</a>
                  <a class="dropdown-item" href="/widget/w_statistics">Weekly</a>
                  <a class="dropdown-item" href="/widget/w_statistics">Monthly</a>
                </div>
              </div>
            </div>
            ...
            <div class="border rounded p-3 my-3">
              <div class="d-flex align-items-center">
                <div class="flex-shrink-0">
                  <img src="/assets/images/user/avatar-1.jpg" alt="img" class="avtar rounded-circle wid-45 hei-45" />
                </div>
                ...
                <div class="dropdown">
                  ...
                  <div class="dropdown-menu dropdown-menu-end">
                    <a class="dropdown-item" href="/widget/w_statistics">Active</a>
                    <a class="dropdown-item" href="/widget/w_statistics">Disable</a>
                    <a class="dropdown-item" href="/widget/w_statistics">Remove</a>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div class="card">
          <div class="card-body">
            ...
            <div class="d-flex align-items-center justify-content-between mt-4">
              ...
              <a href="/widget/w_statistics" class="avtar avtar-s btn btn-primary rounded-circle">
