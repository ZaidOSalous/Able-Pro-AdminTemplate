<script>
  ...
  import simplebar from '$lib/assets/simplebar.js';
  import 'simplebar/dist/simplebar.min.css';
  import dataTable from '$lib/assets/datatable.js';
  let pc_dt_simple = {
    sortable: false,
    perPage: 5
  };
...
<div class="pc-container">
  <div class="pc-content">
    <!-- [ breadcrumb ] start -->
    <Breadcrumb item="Widget" itemActive="Data" />
    <div class="row">
            ...
            <div class="d-flex align-items-center justify-content-between">
              ...
              <div class="dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-end">
                  <a class="dropdown-item" href="/widget/w_data">Today</a>
                  <a class="dropdown-item" href="/widget/w_data">Weekly</a>
                  <a class="dropdown-item" href="/widget/w_data">Monthly</a>
                </div>
              </div>
            </div>
          </div>
            ...
            <li class="list-group-item">
              <div class="d-flex align-items-start">
                ...
                <div class="flex-shrink-0">
                  <a href="/widget/w_data" class="avtar avtar-s btn-link-secondary">
          ...
          <div class="card-body">
            ...
            <ul class="list-inline pt-2">
              <li class="list-inline-item">
                <span class="bg-body rounded fs-6 p-2 border text-body">Fulltime</span>
              </li>
              <li class="list-inline-item">
                <span class="bg-body rounded fs-6 p-2 border text-body">Remote</span>
              </li>
              <li class="list-inline-item">
                <span class="bg-body rounded fs-6 p-2 border text-body">Hourly</span>
              </li>
            </ul>
            <div class="d-flex align-items-center justify-content-between mt-4">
              <ul class="list-inline mb-0 me-2">
                <li class="list-inline-item">
                  <i class="text-muted ti ti-map-pin"></i> Pennsylvania,USA
                </li>
          ...
          <ul class="list-group list-group-flush border-top-0">
            <li class="list-group-item">
              <div class="d-flex align-items-center">
                <div class="flex-shrink-0">
                  <img src="/assets/images/user/avatar-1.jpg" alt="img" class="user-avtar rounded wid-50 hie-50" />
                </div>
            ...
            <li class="list-group-item">
              <div class="d-flex align-items-center">
                <div class="flex-shrink-0">
                  <img src="/assets/images/user/avatar-3.jpg" alt="img" class="user-avtar rounded wid-50 hie-50" />
                </div>
                <div class="flex-grow-1 mx-2">
            ...
            <li class="list-group-item">
              <div class="d-flex align-items-center">
                <div class="flex-shrink-0">
                  <img src="/assets/images/user/avatar-5.jpg" alt="img" class="user-avtar rounded wid-50 hie-50" />
                </div>
                <div class="flex-grow-1 mx-2">
        ...
        <div class="card">
          <div class="card-body">
            ...
            <div class="table-responsive">
              <table class="table table-hover" id="pc-dt-simple" use:dataTable={pc_dt_simple}>
                <thead>
                  <tr>
                    <th>Product</th>
                    <th>Status</th>
                ...
                <tbody>
                  <tr>
                    <td>
                      <div class="row align-items-center">
                        <div class="col-auto pe-0">
                          <img src="/assets/images/widget/img-prod-1.jpg" alt="img" class="wid-55 hei-55 rounded" />
                        </div>
                        <div class="col">
                          <h6 class="mb-2">
                            <span class="text-truncate w-100">Foundations Matte Flip Flop</span>
                          </h6>
                          <p class="text-muted f-12 mb-0">
                            <span class="text-truncate w-100">Leather panels. Laces. Rounded toe. </span>
                          </p>
                        </div>
                      </div>
                    </td>
                    ...
                    <td class="f-w-600">$500 <small class="text-success f-w-400">+20.6 <i class="ti ti-arrow-up"></i></small></td>
                    <td class="f-w-600"
                      ><i class="fas fa-star text-warning"></i> 4.5
                      <span class="f-w-400 text-muted">(65)</span></td
                    >
                  </tr>
                  <tr>
                    <td>
                      <div class="row align-items-center">
                        <div class="col-auto pe-0">
                          <img src="/assets/images/widget/img-prod-2.jpg" alt="img" class="wid-55 hei-55 rounded" />
                        </div>
                        <div class="col">
                          <h6 class="mb-2">
                            <span class="text-truncate w-100">Foundations Matte Flip Flop</span>
                    ...
                    <td class="text-end f-w-600">$98</td>
                    <td class="f-w-600">$500 <small class="text-danger f-w-400">-10.6 <i class="ti ti-arrow-down"></i></small></td>
                    <td class="f-w-600"
                      ><i class="fas fa-star text-warning"></i> 2.5
                      <span class="f-w-400 text-muted">(65)</span></td
                    >
                  </tr>
                  <tr>
                    <td>
                      <div class="row align-items-center">
                        <div class="col-auto pe-0">
                          <img src="/assets/images/widget/img-prod-3.jpg" alt="img" class="wid-55 hei-55 rounded" />
                        </div>
                        <div class="col">
                          <h6 class="mb-2">
                            <span class="text-truncate w-100">Foundations Matte Flip Flop</span>
                    ...
                    <td class="text-end f-w-600">$98</td>
                    <td class="f-w-600">$500 <small class="text-danger f-w-400">20.6 <i class="ti ti-arrow-down"></i></small></td>
                    <td class="f-w-600"
                      ><i class="fas fa-star text-warning"></i> 4.5
                      <span class="f-w-400 text-muted">(65)</span></td
                    >
                  ...
                  <tr>
                    <td>
                      <div class="row align-items-center">
                        <div class="col-auto pe-0">
                          <img src="/assets/images/widget/img-prod-4.jpg" alt="img" class="wid-55 hei-55 rounded" />
                        </div>
                        <div class="col">
                          <h6 class="mb-2">
                            <span class="text-truncate w-100">Foundations Matte Flip Flop</span>
                    ...
                    <td><span class="badge bg-success">Active</span></td>
                    <td class="text-end f-w-600">$98</td>
                    <td class="f-w-600">$500 <small class="text-success f-w-400">-15.4 <i class="ti ti-arrow-up"></i></small></td>
                    <td class="f-w-600"
                      ><i class="fas fa-star text-warning"></i> 3.5
                      <span class="f-w-400 text-muted">(65)</span></td
                    >
                  </tr>
                </tbody>
      ...
      <div class="col-xl-6 col-md-12">
        <div class="card new-cust-card">
          ...
          <div class="customer-scroll" style="height: 415px; position: relative" use:simplebar>
            <div class="card-body p-b-0">
              <div class="align-middle m-b-25">
                <img src="/assets/images/user/avatar-1.jpg" alt="img" class="img-radius align-top m-r-15" />
              ...
              <div class="align-middle m-b-25">
                <img src="/assets/images/user/avatar-2.jpg" alt="img" class="img-radius align-top m-r-15" />
                <div class="d-inline-block">
                  <a href="#!">
                    <h6>John Doue</h6>
                  </a>
              ...
              <div class="align-middle m-b-25">
                <img src="/assets/images/user/avatar-3.jpg" alt="img" class="img-radius align-top m-r-15" />
                <div class="d-inline-block">
                  <a href="#!">
                    <h6>Alex Thompson</h6>
                  </a>
              ...
              <div class="align-middle m-b-25">
                <img src="/assets/images/user/avatar-4.jpg" alt="img" class="img-radius align-top m-r-15" />
                <div class="d-inline-block">
                  <a href="#!">
                    <h6>John Doue</h6>
                  </a>
              ...
              <div class="align-middle m-b-25">
                <img src="/assets/images/user/avatar-5.jpg" alt="img" class="img-radius align-top m-r-15" />
                <div class="d-inline-block">
                  <a href="#!">
                    <h6>Shirley Hoe</h6>
                  </a>
      ...
      <div class="col-xl-6 col-md-12">
        <div class="card table-card">
          <div class="card-header d-flex align-items-center justify-content-between">
            ...
            <a href="/widget/w_data" class="link-primary">View all</a>
          </div>
          <div class="card-body">
            <div class="table-responsive">
              ...
              <div class="d-flex align-items-center">
                ...
                <div class="flex-shrink-0">
                  <div class="dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-end">
                      <a class="dropdown-item" href="/widget/w_data">Name</a>
                      <a class="dropdown-item" href="/widget/w_data">Date</a>
                      <a class="dropdown-item" href="/widget/w_data">Ratting</a>
                      <a class="dropdown-item" href="/widget/w_data">Unread</a>
                    </div>
                  </div>
                </div>
              </div>
        ...
        <div class="card">
          <div class="card-body">
            ...
            <div class="d-flex align-items-center my-3">
              ...
              <div class="flex-grow-1 ms-3">
                <h5 class="mb-0">
                  New Tasks <span class="badge bg-light-secondary rounded-pill">20</span>
                </h5>
              </div>
            </div>
            <div class="my-3">
            ...
            <div class="d-grid gap-3">
              <a href="/widget/w_data" class="btn btn-link-secondary">
                <div class="d-flex align-items-center">
                  <div class="flex-shrink-0">
              ...
              <a href="/widget/w_data" class="btn btn-link-secondary">
                <div class="d-flex align-items-center">
                  ...
                  <div class="badge bg-light-secondary f-12">
                    <i class="ti ti-paperclip text-sm"></i> 8
                  </div>
                </div>
              </a>
            </div>
      ...
      <div class="col-xl-4 col-md-6">
        <div class="card">
          ...
          <div class="card-body p-0 income-scroll" style="height: 265px; position: relative" use:simplebar>
            <div class="mt-3 mb-3">
              <span class="px-4 d-block"><i class="fas fa-circle text-primary f-10 m-r-15"></i>Incoming requests</span>
              <hr class="border border-primary-subtle" />
              <span class="px-4 d-block"><i class="fas fa-circle text-success f-10 m-r-15"></i>You have 2 pending requests..</span>
              <hr class="border border-primary-subtle" />
              <span class="px-4 d-block"><i class="fas fa-circle text-danger f-10 m-r-15"></i>You have 3 pending tasks</span>
              <hr class="border border-primary-subtle" />
              <span class="px-4 d-block"><i class="fas fa-circle text-warning f-10 m-r-15"></i>New order received</span>
              <hr class="border border-primary-subtle" />
              <span class="px-4 d-block"><i class="fas fa-circle text-info f-10 m-r-15"></i>Incoming requests</span>
              <hr class="border border-primary-subtle" />
              <span class="px-4 d-block"
                ><i class="fas fa-circle text-success f-10 m-r-15"></i>The 3 Golden Rules Professional Design..</span
              >
              <hr class="border border-primary-subtle" />
              <span class="px-4 d-block"><i class="fas fa-circle text-danger f-10 m-r-15"></i>You have 4 pending tasks</span>
              <hr class="border border-primary-subtle" />
              <span class="px-4 d-block"><i class="fas fa-circle text-warning f-10 m-r-15"></i>New order received</span>
            </div>
          </div>
      ...
      <div class="col-xl-4 col-md-6">
        <div class="card table-card">
          ...
          <div class="card-body px-0 py-0">
            <div class="table-responsive">
              <div class="revenue-scroll" style="height: 310px; position: relative" use:simplebar>
                <table class="table table-hover mb-0">
                  <tbody>
                    <tr>
                      <td><i class="fas fa-caret-up text-success f-20"></i></td>
                      <td>Bitcoin</td>
                      <td>
                    ...
                    <tr>
                      <td><i class="fas fa-caret-down text-danger f-20"></i></td>
                      <td>Ethereum</td>
                      <td>
          ...
          <div class="card-body">
            <ul class="list-unstyled task-list">
              <li>
                ...
                <h5 class="text-muted">
                  Call to customer <span class="text-primary">
