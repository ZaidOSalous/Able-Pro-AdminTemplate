<script>
  ...
  import Peity from 'peity-vanilla?client';
  onMount(() => {
    Peity.defaults.pie = {
      delimiter: null,
    ...
    document.querySelectorAll('.data-attributes span').forEach((e) => Peity(e, 'pie'));
    ...
    Peity(updatingChartbig, 'line', { width: 64 });
...
<svelte:head>
  <title>Peity Charts | Able Pro Dashboard Template</title>
</svelte:head>
<!-- [ Main Content ] start -->
<div class="pc-container">
  <div class="pc-content">
    <!-- [ breadcrumb ] start -->
    <Breadcrumb item="DataTable" itemActive="Peity Charts" />
    <!-- [ breadcrumb ] end -->
    ...
    <div class="row">
      ...
      <div class="col-md-10 col-xxl-9 mb-4">
            ...
            <div>
              <a class="btn btn-sm btn-light-dark rounded-pill px-2" role="button" target="_blank" href="https://github.com/railsjazz/peity_vanilla?">
