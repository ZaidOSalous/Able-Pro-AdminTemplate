...
<svelte:head>
  <title>Apex Charts | Able Pro Dashboard Template</title>
</svelte:head>
...
<div class="pc-container">
  <div class="pc-content">
    <!-- [ breadcrumb ] start -->
    <Breadcrumb item="DataTable" itemActive="Apex Charts" />
    <!-- [ breadcrumb ] end -->
    ...
    <div class="row">
      ...
      <div class="col-md-10 col-xxl-9 mb-4">
            ...
            <div>
              <a class="btn btn-sm btn-light-dark rounded-pill px-2" role="button" target="_blank" href="https://apexcharts.com/">
    ...
    <div class="row">
      ...
      <div class="col-md-6">
        <div class="card">
          ...
          <div class="card-body">
            <div id="bar-chart-1" use:chart={options_bar_chart_1}></div>
          </div>
        </div>
      </div>
      <div class="col-md-6">
        <div class="card">
          ...
          <div class="card-body">
            <div id="bar-chart-2" use:chart={options_bar_chart_2}></div>
          </div>
        </div>
      </div>
      <div class="col-md-6">
        <div class="card">
          ...
          <div class="card-body">
            <div id="bar-chart-3" use:chart={options_bar_chart_3}></div>
          </div>
        </div>
      </div>
      <div class="col-md-6">
        <div class="card">
          ...
          <div class="card-body">
            <div id="bar-chart-4" use:chart={options_bar_chart_4}></div>
          </div>
        </div>
      </div>
      <div class="col-md-6">
        <div class="card">
          ...
          <div class="card-body">
            <div id="pie-chart-1" style="width: 100%" use:chart={options_pie_chart_1}></div>
          </div>
        </div>
      </div>
      <div class="col-md-6">
        <div class="card">
          ...
          <div class="card-body">
            <div id="pie-chart-2" style="width: 100%" use:chart={options_pie_chart_2}></div>
          </div>
        </div>
      </div>
      <div class="col-md-6">
        <div class="card">
          ...
          <div class="card-body">
            <div id="radialBar-chart-1" use:chart={options_radialbar_1}></div>
          </div>
        </div>
      </div>
      <div class="col-md-6">
        <div class="card">
          ...
          <div class="card-body">
            <div id="radialBar-chart-2" use:chart={options_radialbar_2}></div>
          </div>
        </div>
      </div>
      <div class="col-md-6">
        <div class="card">
          ...
          <div class="card-body">
            <div id="line-chart-1" use:chart={line_chart_1}></div>
          </div>
        </div>
      </div>
      <div class="col-md-6">
        <div class="card">
          ...
          <div class="card-body">
            <div id="line-chart-2" use:chart={options_real_time}></div>
          </div>
        </div>
      </div>
      <div class="col-md-12">
        <div class="card">
          ...
          <div class="card-body">
            <div id="line-chart-3" use:chart={options_different}></div>
          </div>
        </div>
      </div>
      <div class="col-md-6">
        <div class="card">
          ...
          <div class="card-body">
            <div id="area-chart-1" use:chart={options_area_chart_1}></div>
          </div>
        </div>
      </div>
      <div class="col-md-6">
        <div class="card">
          ...
          <div class="card-body">
            ...
            <div id="area-chart-2" use:chart={options_area_chart_2}></div>
          </div>
        </div>
      </div>
      ...
      <div class="col-md-6">
        <div class="card">
          ...
          <div class="card-body">
            <div id="mixed-chart-1" use:chart={options_mixed_chart_1}></div>
          </div>
        </div>
      </div>
      <div class="col-md-6">
        <div class="card">
          ...
          <div class="card-body">
            <div id="mixed-chart-2" use:chart={options_mixed_chart_2}></div>
          </div>
        </div>
      </div>
      <div class="col-md-12">
        <div class="card">
          ...
          <div class="card-body">
            <div id="candlestick-chart-1" use:chart={options_candlestick}></div>
          </div>
        </div>
      </div>
      <div class="col-md-6">
        <div class="card">
          ...
          <div class="card-body">
            <div id="bubble-chart-1" use:chart={options_bubble_chart_1}></div>
          </div>
        </div>
      </div>
      <div class="col-md-6">
        <div class="card">
          ...
          <div class="card-body">
            <div id="bubble-chart-2" use:chart={options_bubble_chart_2}></div>
          </div>
        </div>
      </div>
      <div class="col-md-6">
        <div class="card">
          ...
          <div class="card-body">
            <div id="scatter-chart-1" use:chart={options_scatter_chart_1}></div>
          </div>
        </div>
      </div>
      <div class="col-md-6">
        <div class="card">
          ...
          <div class="card-body">
            <div id="scatter-chart-2" use:chart={options_scatter_chart_2}></div>
          </div>
        </div>
      </div>
      <div class="col-md-6">
        <div class="card">
          ...
          <div class="card-body">
            <div id="heatmap-chart-1" use:chart={options_heatmap_chart_1}></div>
          </div>
        </div>
      </div>
      <div class="col-md-6">
        <div class="card">
          ...
          <div class="card-body">
            <div id="heatmap-chart-2" use:chart={options_heatmap_chart_2}></div>
          </div>
        </div>
      </div>
      <div class="col-md-6">
        <div class="card">
          ...
          <div class="card-body">
            <div id="radar-chart-1" use:chart={options_radar_chart_1}></div>
          </div>
        </div>
      </div>
      <div class="col-md-6">
        <div class="card">
          ...
          <div class="card-body">
            <div id="radar-chart-2" use:chart={options_radar_chart_2}></div>
          </div>
        </div>
      </div>
      <!-- [ variant-chart ] end -->
