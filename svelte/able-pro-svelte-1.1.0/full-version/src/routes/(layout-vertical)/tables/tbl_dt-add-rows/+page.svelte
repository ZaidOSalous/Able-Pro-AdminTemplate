<script>
  ...
  onMount(() => {
    document.getElementById('add').addEventListener('click', function (e) {
      dataList.insert({
        data: dataList.options.data.data
      });
    });
  });
</script>
...
<svelte:head>
  <title>Add Rows Bootstrap Table | Able Pro Dashboard Template</title>
</svelte:head>
...
<div class="pc-container">
  <div class="pc-content">
    <!-- [ breadcrumb ] start -->
    <Breadcrumb item="Table" itemActive="Add Row" />
    <!-- [ breadcrumb ] end -->
        ...
        <div class="card">
          ...
          <div class="card-body table-border-style">
            ...
            <div class="table-responsive">
              <table class="table" id="pc-dt-addrow" use:dataTable={pc_dt_addrow}>
                <thead>
                  <tr>
                    <th>Name</th>
                    <th>Ext.</th>
