<script>
  ...
  import { DataTable, convertJSON, convertCSV, exportCSV, exportSQL, exportJSON } from 'simple-datatables';
...
<svelte:head>
  <title>Table Methods | Able Pro Dashboard Template</title>
</svelte:head>
...
<div class="pc-container">
  <div class="pc-content">
    <!-- [ breadcrumb ] start -->
    <Breadcrumb item="Table" itemActive="Table Methods" />
    <!-- [ breadcrumb ] end -->
    ...
    <div class="row">
      ...
      <div class="col-md-10 col-xxl-9 mb-4">
            <h5>Simple-datatables</h5>
            <p class="text-muted">A lightweight, extendable, JavaScript HTML table library written in TypeScript and transpilled to Vanilla JavaScript. Similar to jQuery DataTables for use in modern browsers, but without the jQuery dependency.</p>
            <div>
            ...
            <div class="row">
              ...
              <div class="col-md-6">
                ...
                <div class="mb-3 btn-page">
                  <button type="button" class="btn btn-light-primary btn-sm import" data-type="csv">Import CSV</button>
                  <button type="button" class="btn btn-light-primary btn-sm import" data-type="json">Import JSON</button>
                  <button type="button" class="btn btn-light-success btn-sm export" data-type="csv">Export CSV</button>
                  <button type="button" class="btn btn-light-success btn-sm export" data-type="sql">Export SQL</button>
                  <button type="button" class="btn btn-light-success btn-sm export" data-type="json">Export JSON</button>
                </div>
                <div class="mb-3">
                  <small
                    >NOTE: The csv column delimiters and line delimiters are set to <code>","</code> and
