<script>
  ...
  onMount(() => {
    ...
    var table = new DataTable('#dt-plugin-method');

    jQuery('<button class="btn  btn-primary m-b-10">sum of age in all rows</button>')
      .prependTo('.dt-plugin-buttons')
      .on('click', function () {
        alert('Column sum is: ' + table.column(3).data().sum());
      });

    jQuery('<button class="btn  btn-primary m-r-10 m-b-10">sum of age of visible rows</button>')
      .prependTo('.dt-plugin-buttons')
      .on('click', function () {
        alert(
          'Column sum is: ' +
    ...
    var dtage = jQuery('#dt-range').DataTable();
...
<div class="pc-container">
  <div class="pc-content">
    <!-- [ breadcrumb ] start -->
    <Breadcrumb item="DataTable" itemActive="Plug-ins" />
    <!-- [ breadcrumb ] end -->
      ...
      <div class="col-sm-12">
        <div class="card">
          <div class="card-header">
            ...
            <small
              >There may be occasions when you wish to search data presented to the end user in your own manner, common examples are number
              range searches (in between two numbers) and date range searches</small
            >
          </div>
          <div class="card-body">
            <div class="dt-responsive table-responsive">
