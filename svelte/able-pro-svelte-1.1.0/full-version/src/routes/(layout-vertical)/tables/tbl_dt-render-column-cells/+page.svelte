<script>
  ...
  import { DataTable, convertCSV } from 'simple-datatables?client';
  ...
  onMount(() => {
    new DataTable('#pc-dt-render-column-cells', {
      data,
      perPage: 25,
...
<svelte:head>
  <title>Render Column Cells | Able Pro Dashboard Template</title>
</svelte:head>
...
<div class="pc-container">
  <div class="pc-content">
    <!-- [ breadcrumb ] start -->
    <Breadcrumb item="Table" itemActive="Render Column Cells" />
    <!-- [ breadcrumb ] end -->
