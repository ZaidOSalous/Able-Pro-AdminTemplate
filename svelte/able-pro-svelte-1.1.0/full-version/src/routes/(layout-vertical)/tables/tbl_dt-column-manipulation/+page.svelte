<script>
  ...
  import { DataTable } from 'simple-datatables?client';
...
<svelte:head>
  <title>Column Manipulation Bootstrap Table | Able Pro Dashboard Template</title>
</svelte:head>
...
<div class="pc-container">
  <div class="pc-content">
    <!-- [ breadcrumb ] start -->
    <Breadcrumb item="Table" itemActive="Column Manipulation" />
    <!-- [ breadcrumb ] end -->
