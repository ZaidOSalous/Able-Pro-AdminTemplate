      ...
      <div class="card-body pc-component">
        <div class="d-flex flex-wrap gap-2">
          ...
          <div class="btn-group dropup">
            <button type="button" class="btn btn-success dropdown-toggle" data-bs-toggle="dropdown" aria-expanded="false"> Dropup </button>
            <div class="dropdown-menu">
              <a class="dropdown-item" href="#!">Action</a>
              <a class="dropdown-item" href="#!">Another action</a>
              <a class="dropdown-item" href="#!">Something else here</a>
          ...
          <div class="btn-group dropup">
            ...
            <button
              type="button"
              class="btn btn-light-success dropdown-toggle dropdown-toggle-split"
              data-bs-toggle="dropdown"
              aria-expanded="false"
            >
              <span class="visually-hidden">Toggle Dropdown</span>
  ...
  <div class="col-md-4">
    <div class="card">
      ...
      <div class="card-body pc-component">
        <div class="btn-group mb-2 me-2">
          <button
            class="btn btn-light-success dropdown-toggle"
            type="button"
            data-bs-toggle="dropdown"
            aria-haspopup="true"
            aria-expanded="false">Forms</button
          >
  ...
  <div class="col-md-12">
    <div class="card">
      ...
      <div class="card-body pc-component">
        <div class="btn-group mr-2 mb-2">
          <button
            class="btn btn-light-info dropdown-toggle"
            type="button"
            id="defaultDropdown"
            data-bs-toggle="dropdown"
