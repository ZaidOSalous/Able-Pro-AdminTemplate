...
<div class="row">
  ...
  <ComponentBreadcrumb
						...
						link={'https://getbootstrap.com/docs/5.2/components/typography/'}
					/>
</div>
<!-- [ Main Content ] start -->
<div class="row">
  ...
  <div class="col-sm-12">
    <div class="card">
      <div class="card-header">
        <h5>Headings</h5>
        <p>
          <span class="badges">.h1</span> through .h6 classes are also available, for when you want to match the font styling of a heading but
