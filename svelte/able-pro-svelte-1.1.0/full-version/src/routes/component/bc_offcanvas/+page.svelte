    ...
    <div class="card">
      ...
      <div class="card-body btn-page pc-component">
        ...
        <button
          ...
          aria-controls="offcanvasTop">Top offcanvas <i data-feather="chevrons-up"></i></button
        >
        ...
        <button
          ...
          aria-controls="offcanvasRight">Right offcanvas <i data-feather="chevrons-right"></i></button
        >
        ...
        <button
          ...
          aria-controls="offcanvasBottom">Bottom offcanvas <i data-feather="chevrons-down"></i></button
        >
