...
&lt;/div&gt;
  ...
  let code5 = `<pre><code class="language-css">a:active {
    color: #1abc9c;
}
p {
    font-size: 13px;
...
.panel-primary {
  ...
  let code6 = ` <pre class="line-numbers language-js">
...
&lt;/pre&gt;
  ...
  let code7 = ` <pre class="line-numbers">
                                            <code class="language-js">
(function() {
...
&lt;/pre&gt;
  ...
  let code9 = `<pre data-line="2,4,7-9">
											<code class="language-css">
pre.line-numbers {
    position: relative;
    padding-left: 3.8em;
...
<div class="row">
  ...
  <div class="col-sm-12">
    <div class="card">
      ...
      <div class="card-body">
        <p>
          The recommended way to mark up a code block (both for semantics and for Prism) is a <code>&lt;pre&gt;</code>
          element with a element <code>&lt;code&gt;</code> inside, like so:
        </p>
    ...
    <div class="card">
      ...
      <div class="card-body">
        ...
        <p>
          ...
          line-numbers to your desired
          <code>&lt;pre&gt;</code> and line-numbers plugin will take care.
        </p>
        <p>
  ...
  <div class="col-sm-12">
    <div class="card">
      ...
      <div class="card-body">
        ...
        <p>
          You specify the lines to be highlighted through the data-line attribute on the <code>&lt;pre&gt;</code> element, in the following simple
          format:
        </p>
        <ol>
