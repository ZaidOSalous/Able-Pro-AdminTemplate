<script>
  ...
  import bootstrap from 'bootstrap/dist/js/bootstrap.bundle.min.js?client';
  import codeComponent from '$lib/assets/component.js';
  onMount(() => {
    //copy btn and code btn
    codeComponent();
    // Ensure Bootstrap JS is available
    const carouselElement = [].slice.call(document.querySelectorAll('[data-bs-ride="carousel"]'));
    carouselElement.map(function (el) {
    ...
    <div class="card">
      ...
      <div class="card-body pc-component">
        <div id="carouselExample_Indicators_caption" class="carousel slide" data-bs-ride="carousel">
          ...
          <a class="carousel-control-prev" href="#carouselExample_Indicators_caption" role="button" data-bs-slide="prev"
            ><span class="carousel-control-prev-icon" aria-hidden="true"></span><span class="sr-only">Previous</span></a
          >
          <a class="carousel-control-next" href="#carouselExample_Indicators_caption" role="button" data-bs-slide="next"
            ><span class="carousel-control-next-icon" aria-hidden="true"></span><span class="sr-only">Next</span></a
          >
        </div>
      </div>
    ...
    <div class="card">
      ...
      <div class="card-body pc-component">
        <div id="carouselExampleDark" class="carousel carousel-dark slide" data-bs-ride="carousel">
          ...
          <div class="carousel-inner">
            <div class="carousel-item active">
              <img class="img-fluid d-block w-100" src="../assets/images/light-box/l6.jpg" alt="First slide" />
              <div class="carousel-caption d-none d-md-block">
            ...
            <div class="carousel-item">
              <img class="img-fluid d-block w-100" src="../assets/images/light-box/l5.jpg" alt="Second slide" />
              <div class="carousel-caption d-none d-md-block">
            ...
            <div class="carousel-item">
              <img class="img-fluid d-block w-100" src="../assets/images/light-box/l6.jpg" alt="Third slide" />
              <div class="carousel-caption d-none d-md-block">
    ...
    <div class="card">
      ...
      <div class="card-body pc-component">
        <div id="carouselExampleControlsNoTouching" class="carousel slide" data-bs-touch="false" data-bs-interval="false">
          <div class="carousel-inner">
            <div class="carousel-item active">
              <img class="img-fluid d-block w-100" src="../assets/images/slider/img-slide-3.jpg" alt="First slide" />
            </div>
            <div class="carousel-item">
              <img class="img-fluid d-block w-100" src="../assets/images/slider/img-slide-4.jpg" alt="First slide" />
            </div>
            <div class="carousel-item">
              <img class="img-fluid d-block w-100" src="../assets/images/slider/img-slide-5.jpg" alt="First slide" />
            </div>
          </div>
