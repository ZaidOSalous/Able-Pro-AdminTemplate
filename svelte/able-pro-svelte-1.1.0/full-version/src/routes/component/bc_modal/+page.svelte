...
<div class="row">
              ...
              <div class="modal-body">
                ...
                <p>
                  ...
                  <a
                    href="#!"
                    role="button"
                    class="btn btn-secondary tooltip-test"
                    data-bs-toggle="tooltip"
                    title="Button Tooltip"
                    data-bs-container="#exampleModalPopovers">button</a
                  >
                ...
                <p>
                  <a href="#!" class="tooltip-test" data-bs-toggle="tooltip" title="Tooltip" data-bs-container="#exampleModalPopovers"
                    >This link</a
                  >
                  and
                  <a href="#!" class="tooltip-test" data-bs-toggle="tooltip" title="Tooltip" data-bs-container="#exampleModalPopovers"
  ...
  <div class="col-xl-4 col-md-6">
    <div class="card">
      ...
      <div class="card-body pc-component">
        <button type="button" class="btn btn-primary mr-2 mb-2" data-bs-toggle="modal" data-bs-target=".bd-example-modal-lg"
          >Large modal</button
        >
        <button type="button" class="btn btn-primary mr-2 mb-2" data-bs-toggle="modal" data-bs-target=".bd-example-modal-sm"
          >Small modal</button
        >
  ...
  <div class="col-xl-4 col-md-6">
    <div class="card">
      ...
      <div class="card-body pc-component">
            ...
            <div class="modal-content">
              <div class="modal-header">
                <h5 class="modal-title" id="exampleModalToggleLabel">
                  <span class="badge bg-danger">1</span> First Modal
                </h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
              </div>
              <div class="modal-body"> Show a second modal and hide this one with the button below. </div>
              <div class="modal-footer">
                <button class="btn btn-light-primary" data-bs-target="#exampleModalToggle2" data-bs-toggle="modal" data-bs-dismiss="modal"
            ...
            <div class="modal-content">
              <div class="modal-header">
                <h5 class="modal-title" id="exampleModalToggleLabel2">
                  <span class="badge bg-success">2</span> Second Modal
                </h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
              </div>
              <div class="modal-body"> Hide this modal and show the first with the button below. </div>
              <div class="modal-footer">
                <button class="btn btn-light-secondary" data-bs-target="#exampleModalToggle" data-bs-toggle="modal" data-bs-dismiss="modal"
        ...
        <a class="btn btn-primary" data-bs-toggle="modal" href="#exampleModalToggle" role="button">Openfirst modal</a>
      </div>
    </div>
  </div>
    ...
    <div class="card">
      ...
      <div class="card-body pc-component btn-page">
        ...
        <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#exampleModal" data-bs-whatever="@getbootstrap"
          >Open modal for @bootstrap</button
        >
