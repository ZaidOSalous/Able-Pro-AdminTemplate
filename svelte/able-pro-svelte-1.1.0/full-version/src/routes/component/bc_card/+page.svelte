...
<div class="row">
  ...
  <div class="col-md-6 col-xxl-4">
    ...
    <div class="pc-component">
      <div class="card mb-3">
        <img class="img-fluid card-img-top" src="../assets/images/light-box/l3.jpg" alt="" />
        <div class="card-body">
          <h5 class="card-title">Card title</h5>
          <p class="card-text">
  ...
  <div class="col-md-6 col-xxl-4">
    ...
    <div class="pc-component">
      <div class="card">
        ...
        <img class="img-fluid card-img-bottom" src="../assets/images/light-box/l3.jpg" alt="" />
      </div>
    </div>
  </div>
  <div class="col-md-6 col-xxl-4">
    ...
    <div class="pc-component">
      <div class="card bg-dark">
        <img class="img-fluid card-img" src="../assets/images/light-box/l3.jpg" alt="img" />
