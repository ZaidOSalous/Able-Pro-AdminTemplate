    ...
    <div class="card btn-page">
      ...
      <div class="card-body pc-component">
        <div class="d-flex flex-wrap gap-2">
          <button type="button" class="btn btn-primary">primary <span class="badge bg-light text-dark">4</span></button>
          ...
          <button type="button" class="btn btn-info position-relative ms-2"
            >Profile
