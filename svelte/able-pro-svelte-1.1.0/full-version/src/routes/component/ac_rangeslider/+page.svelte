<script>
  ...
  import Slider from 'bootstrap-slider/dist/bootstrap-slider.min.js?client';
...
<div class="row">
  ...
  <div class="col-lg-4 col-md-6">
    <div class="card">
      <div class="card-body">
        <h6>
          Destroy instance of slider by calling <code>destroy()</code> method on slider instance via JavaScript.
        </h6>
        <hr />
    ...
    <div class="card">
      <div class="card-body">
        ...
        <input
          id="ex14"
          type="text"
          data-slider-ticks="[0, 10, 20, 30, 40]"
          data-slider-ticks-snap-bounds="95"
          data-slider-ticks-labels={['$0', '$10', '$20', '$30', '$40']}
