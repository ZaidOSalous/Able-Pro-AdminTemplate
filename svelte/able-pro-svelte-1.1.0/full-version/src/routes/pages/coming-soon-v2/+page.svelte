...
<svelte:head>
  <title>Coming Soon | Able Pro Dashboard Template</title>
</svelte:head>
        ...
        <div class="card soon-card">
          <div class="card-body">
            <div class="row justify-content-center align-items-center">
              <div class="col-md-6">
                <img class="img-fluid" src="/assets/images/pages/img-soon-2.svg" alt="img" />
              </div>
              <div class="col-md-4">
                ...
                <div class="row d-flex my-4 align-items-center">
                  <div class="col">
                ...
                <ul class="list-inline d-flex align-items-center justify-content-center mb-0">
                  <li class="list-inline-item">
                    <a href="/pages/coming-soon-v2" class="btn btn-icon btn-link-secondary">
                      <svg class="pc-icon">
