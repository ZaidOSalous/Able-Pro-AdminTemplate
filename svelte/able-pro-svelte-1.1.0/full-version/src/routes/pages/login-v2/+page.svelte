      ...
      <div class="card my-5">
        <div class="card-body">
          <div class="text-center">
            <a href="/pages/login-v2"><img src="/assets/images/logo-dark.svg" alt="img" /></a>
          ...
          <div class="d-flex mt-1 justify-content-between align-items-center">
            ...
            <h6 class="text-secondary f-w-400 mb-0">
              <a href="/pages/forgot-password-v2"> Forgot Password? </a>
            </h6>
          </div>
          ...
          <div class="d-flex justify-content-between align-items-end mt-4">
            ...
            <a href="/pages/register-v2" class="link-primary">Create Account</a>
          </div>
        </div>
      </div>
    </div>
