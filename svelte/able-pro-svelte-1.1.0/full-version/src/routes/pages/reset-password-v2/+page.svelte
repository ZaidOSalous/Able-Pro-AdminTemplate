...
<svelte:head>
  <title>Reset Password | Able Pro Dashboard Template</title>
</svelte:head>
...
<div class="auth-main">
  <div class="auth-wrapper v2">
    ...
    <div class="auth-form">
      <div class="card my-5">
        <div class="card-body">
          <a href="/pages/reset-password-v1"><img src="/assets/images/logo-dark.svg" class="mb-4 img-fluid" alt="img" /></a>
          <div class="mb-4">
