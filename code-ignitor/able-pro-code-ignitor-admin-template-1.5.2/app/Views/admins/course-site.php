...
<html lang="en">
                  ...
                  <div class="tab-pane show active" id="contactDetail">
                    ...
                    <div class="d-flex align-items-center mb-4">
                      <div class="flex-shrink-0">
                        <img src="<?= base_url('assets/images/admin/img-star.png') ?>" alt="img" class="img-fluid">
                      </div>
                        ...
                        <div class="card border text-center">
                          <div class="card-body">
                            ...
                            <p class="text-muted">If you edit this domain, your school URL will update the next time you
                              log out.</p>
                            <img src="<?= base_url('assets/images/admin/img-domain.png') ?>" alt="images" class="img-fluid mb-4">
                        ...
                        <div class="modal-content">
                          ...
                          <div class="modal-body">
                            <div class="d-flex flex-column gap-3 align-items-center mb-4">
                              <img src="<?= base_url('assets/images/admin/img-add-user.png') ?>" alt="img" class="img-fluid">
  ...
  <?= $this->include('partials/customizer.php') ?>
    ...
    <script src="<?= base_url('assets/js/plugins/wizard.min.js') ?>"></script>
