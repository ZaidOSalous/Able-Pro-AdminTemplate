...
<html lang="en">
  ...
  <!-- custom widget js -->
  <script src="<?= base_url('assets/js/widgets/support-chart.js') ?>"></script>
  <script src="<?= base_url('assets/js/widgets/support-chart1.js') ?>"></script>
  <script src="<?= base_url('assets/js/widgets/support-chart2.js') ?>"></script>
  <script src="<?= base_url('assets/js/widgets/satisfaction-chart.js') ?>"></script>
  <script>
