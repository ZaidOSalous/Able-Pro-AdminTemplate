              ...
              <div class="row">
                <div class="col-sm-auto mb-3 mb-sm-0">
                  <div class="d-sm-inline-block d-flex align-items-center">
                    <img class="media-object wid-60 img-radius" src="<?= base_url('assets/images/user/avatar-1.jpg') ?>"
                ...
                <div class="col">
                  <div class="popup-trigger">
                    ...
                    <div class="help-sm-hidden">
                      <ul class="list-unstyled mt-2 mb-0 text-muted">
                        <li class="d-sm-inline-block d-block mt-1"><img src="<?= base_url('assets/images/admin/p1.jpg') ?>" alt=""
                            class="wid-20 rounded me-2 img-fluid">Piaf able</li>
                        <li class="d-sm-inline-block d-block mt-1"><img src="<?= base_url('assets/images/user/avatar-5.jpg') ?>" alt=""
                    ...
                    <div class="help-md-hidden">
                      <div class="bg-body mb-3 p-3">
                        <h6><img src="<?= base_url('assets/images/user/avatar-5.jpg') ?>" alt="" class="wid-20 avatar me-2 rounded">Last
                  ...
                  <div class="mt-2">
                    <a href="helpdesk-ticket-details.html" class="me-2 btn btn-sm btn-light-primary"><i
          ...
          <div class="right-side">
              ...
              <ul class="list-group list-group-flush pb-2">
                <li class="list-group-item">
                  <div class="d-inline-block">
                    <img src="<?= base_url('assets/images/admin/p1.jpg') ?>" alt="" class="wid-20 rounded me-1 img-fluid">
                ...
                <li class="list-group-item">
                  <div class="d-inline-block">
                    <img src="<?= base_url('assets/images/admin/p2.jpg') ?>" alt="" class="wid-20 rounded me-1 img-fluid">
                ...
                <li class="list-group-item">
                  <div class="d-inline-block">
                    <img src="<?= base_url('assets/images/admin/p3.jpg') ?>" alt="" class="wid-20 rounded me-1 img-fluid">
                ...
                <li class="list-group-item">
                  <div class="d-inline-block">
                    <img src="<?= base_url('assets/images/admin/p4.jpg') ?>" alt="" class="wid-20 rounded me-1 img-fluid">
                ...
                <li class="list-group-item">
                  <div class="d-inline-block">
                    <img src="<?= base_url('assets/images/admin/p5.jpg') ?>" alt="" class="wid-20 rounded me-1 img-fluid">
            ...
            <div class="card">
              ...
              <ul class="list-group list-group-flush pb-2">
                <li class="list-group-item">
                  <div class="d-inline-block">
                    <img src="<?= base_url('assets/images/user/avatar-5.jpg') ?>" alt="" class="wid-20 rounded me-1 img-fluid">
                ...
                <li class="list-group-item">
                  <div class="d-inline-block">
                    <img src="<?= base_url('assets/images/user/avatar-4.jpg') ?>" alt="" class="wid-20 rounded me-1 img-fluid">
                ...
                <li class="list-group-item">
                  <div class="d-inline-block">
                    <img src="<?= base_url('assets/images/user/avatar-3.jpg') ?>" alt="" class="wid-20 rounded me-1 img-fluid">
                ...
                <li class="list-group-item">
                  <div class="d-inline-block">
                    <img src="<?= base_url('assets/images/user/avatar-2.jpg') ?>" alt="" class="wid-20 rounded me-1 img-fluid">
                ...
                <li class="list-group-item">
                  <div class="d-inline-block">
                    <img src="<?= base_url('assets/images/user/avatar-1.jpg') ?>" alt="" class="wid-20 rounded me-1 img-fluid">
      ...
      <div class="modal-content">
        ...
        <div class="scroll-div position-relative" style="height: calc(100vh - 90px);">
            ...
            <div class="row">
              <div class="col-md-7">
                <span type="button" class="badge bg-light-success me-1"><i class="feather icon-check me-1"></i>
                  Closed</span>
                <p class="list-inline-item mb-0"><img src="<?= base_url('assets/images/admin/p1.jpg') ?>" alt=""
          ...
          <div class="modal-body border-bottom px-4">
            <div class="row">
              <div class="col-auto">
                <img class="media-object wid-60 img-radius" src="<?= base_url('assets/images/user/avatar-5.jpg') ?>"
                  alt="Generic placeholder image ">
              </div>
              <div class="col">
...
<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>pre</span><span class="token punctuation">&gt;</span></span>
  ...
  <script src='<?= base_url('assets/js/plugins/quill.js') ?>'></script>
