              ...
              <div class="card-body">
                ...
                <div class="tab-content">
                    ...
                    <div class="row justify-content-center">
                      <div class="col-md-10 col-lg-8 col-xxl-6">
                        <div class="card border text-center">
                          <div class="card-body">
                            <img src="<?= base_url('assets/images/admin/img-payment-1.png') ?>" alt="images" class="img-fluid mb-4">
                  ...
                  <div class="tab-pane" id="auth-2" role="tabpanel" aria-labelledby="auth-tab-2">
                    <button class="btn btn-link-secondary d-flex align-items-center" onClick="change_tab('#auth-1')"><i class="ti ti-chevron-left"></i> Back Step</button>
                    <div class="row justify-content-center">
                      <div class="col-md-10 col-lg-8 col-xxl-6">
                        <div class="card border text-center">
                          <div class="card-body">
                  ...
                  <div class="tab-pane" id="auth-3" role="tabpanel" aria-labelledby="auth-tab-3">
                    <button class="btn btn-link-secondary d-flex align-items-center" onClick="change_tab('#auth-2')"><i class="ti ti-chevron-left"></i> Back Step</button>
                    <div class="row justify-content-center">
                      <div class="col-md-10 col-lg-8 col-xxl-6">
                        <div class="card border text-center">
                          <div class="card-body">
                            <img src="<?= base_url('assets/images/admin/img-payment-2.png') ?>" alt="images" class="img-fluid mb-4">
                  ...
                  <div class="tab-pane" id="auth-4" role="tabpanel" aria-labelledby="auth-tab-4">
                    <button class="btn btn-link-secondary d-flex align-items-center" onClick="change_tab('#auth-3')"><i class="ti ti-chevron-left"></i> Back Step</button>
                    <div class="row justify-content-center">
                      <div class="col-md-10 col-lg-8 col-xxl-6">
                        <div class="card border text-center">
                          <div class="card-body">
