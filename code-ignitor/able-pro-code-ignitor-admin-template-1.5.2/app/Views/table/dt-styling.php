          ...
          <div class="col-sm-12">
            <div class="card">
              <div class="card-header">
                <h5>Base Style</h5>
                <small
                  >The DataTables default style file has a number of features which can be enabled based on the class name of the
                  table</small
                >
              </div>
              <div class="card-body">
          ...
          <div class="col-sm-12">
            <div class="card">
              <div class="card-header">
                ...
                <small
                  >This example shows the base DataTables style file being used, with none of the additional feature style classes being
                  used.</small
                >
              </div>
              <div class="card-body">
          ...
          <div class="col-sm-12">
            <div class="card">
              <div class="card-header">
                ...
                <small
                  >The compact class reduces the amount of white-space in the default styling, increasing the information density on screen,
