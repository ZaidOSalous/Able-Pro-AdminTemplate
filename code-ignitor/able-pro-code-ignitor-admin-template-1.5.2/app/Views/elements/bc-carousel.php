                  ...
                  <div id="carouselExampleSlidesOnly" class="carousel slide" data-bs-ride="carousel">
                    <div class="carousel-inner">
                      <div class="carousel-item active">
                        <img class="img-fluid d-block w-100" src="<?= base_url('assets/images/slider/img-slide-1.jpg') ?>"
                          alt="First slide">
                      </div>
                      <div class="carousel-item">
                        <img class="img-fluid d-block w-100" src="<?= base_url('assets/images/slider/img-slide-2.jpg') ?>"
                          alt="Second slide">
                      </div>
                      <div class="carousel-item">
                        <img class="img-fluid d-block w-100" src="<?= base_url('assets/images/slider/img-slide-3.jpg') ?>"
                          alt="Third slide">
                      </div>
                    </div>
                  </div>
              ...
              <div class="card">
                ...
                <div class="card-body pc-component">
                  <div id="carouselExampleControls" class="carousel slide" data-bs-ride="carousel">
                    <div class="carousel-inner">
                      <div class="carousel-item active">
                        <img class="img-fluid d-block w-100" src="<?= base_url('assets/images/slider/img-slide-4.jpg') ?>"
                          alt="First slide">
                      </div>
                      <div class="carousel-item">
                        <img class="img-fluid d-block w-100" src="<?= base_url('assets/images/slider/img-slide-3.jpg') ?>"
              ...
              <div class="card">
                ...
                <div class="card-body pc-component">
                  <div id="carouselExampleDark" class="carousel carousel-dark slide" data-bs-ride="carousel">
                    ...
                    <div class="carousel-inner">
                      <div class="carousel-item active">
                        <img class="img-fluid d-block w-100" src="<?= base_url('assets/images/light-box/l6.jpg') ?>"
                          alt="First slide">
                        <div class="carousel-caption d-none d-md-block">
                      ...
                      <div class="carousel-item">
                        <img class="img-fluid d-block w-100" src="<?= base_url('assets/images/light-box/l5.jpg') ?>"
                          alt="Second slide">
                        <div class="carousel-caption d-none d-md-block">
                ...
                <div class="card-body pc-component">
                  <div id="carouselExampleControlsNoTouching" class="carousel slide" data-bs-touch="false"
                    ...
                    <div class="carousel-inner">
                      ...
                      <div class="carousel-item">
                        <img class="img-fluid d-block w-100" src="<?= base_url('assets/images/slider/img-slide-5.jpg') ?>"
                          alt="First slide">
                      </div>
                    </div>
