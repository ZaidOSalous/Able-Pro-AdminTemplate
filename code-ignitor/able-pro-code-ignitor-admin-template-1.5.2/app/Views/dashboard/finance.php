...
<html lang="en">
        ...
        <div class="col-md-5 col-xxl-4">
          <div class="card">
            <div class="card-body">
              ...
              <div class="card rounded-4 overflow-hidden" style="background-image: url(<?= base_url('assets/images/widget/img-card-bg.svg') ?>); background-size: cover;">
                <div class="card-body">
                  <div class="d-flex">
                    ...
                    <div class="flex-shrink-0">
                      <img src="<?= base_url('assets/images/widget/img-card-master.svg') ?>" alt="img" class="img-fluid">
                    </div>
                  </div>
              ...
              <div class="row g-3">
                <div class="col-md-6 col-xxl-3">
                  <div class="card shadow-none border mb-0">
                    <div class="card-body p-3">
                      <div class="d-flex align-items-center justify-content-between mb-3">
                        <img src="<?= base_url('assets/images/widget/img-food.png') ?>" alt="img" class="img-fluid">
                        <div class="dropdown">
                          <a class="avtar avtar-xs btn-link-secondary dropdown-toggle arrow-none" href="#"
                            data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            <i class="ti ti-dots-vertical f-18"></i>
                ...
                <div class="col-md-6 col-xxl-3">
                  <div class="card shadow-none border mb-0">
                    <div class="card-body p-3">
                      <div class="d-flex align-items-center justify-content-between mb-3">
                        <img src="<?= base_url('assets/images/widget/img-travel.png') ?>" alt="img" class="img-fluid">
                        <div class="dropdown">
                          <a class="avtar avtar-xs btn-link-secondary dropdown-toggle arrow-none" href="#"
                            data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            <i class="ti ti-dots-vertical f-18"></i>
                ...
                <div class="col-md-6 col-xxl-3">
                  <div class="card shadow-none border mb-0">
                    <div class="card-body p-3">
                      <div class="d-flex align-items-center justify-content-between mb-3">
                        <img src="<?= base_url('assets/images/widget/img-shoping.png') ?>" alt="img" class="img-fluid">
                        <div class="dropdown">
                          <a class="avtar avtar-xs btn-link-secondary dropdown-toggle arrow-none" href="#"
                            data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            <i class="ti ti-dots-vertical f-18"></i>
                ...
                <div class="col-md-6 col-xxl-3">
                  <div class="card shadow-none border mb-0">
                    <div class="card-body p-3">
                      <div class="d-flex align-items-center justify-content-between mb-3">
                        <img src="<?= base_url('assets/images/widget/img-helth.png') ?>" alt="img" class="img-fluid">
                        <div class="dropdown">
                          <a class="avtar avtar-xs btn-link-secondary dropdown-toggle arrow-none" href="#"
                            data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            <i class="ti ti-dots-vertical f-18"></i>
                ...
                <div class="col-12">
                  <div class="card shadow-none border mb-0">
                    <div class="card-body p-3">
                      <div class="d-flex align-items-center">
                        <div class="flex-shrink-0">
                          <img src="<?= base_url('assets/images/widget/img-card-1.png') ?>" alt="img" class="img-fluid">
                        </div>
                        <div class="flex-grow-1 ms-3">
                ...
                <div class="col-12">
                  <div class="card shadow-none border mb-0">
                    <div class="card-body p-3">
                      <div class="d-flex align-items-center">
                        <div class="flex-shrink-0">
                          <img src="<?= base_url('assets/images/widget/img-card-2.png') ?>" alt="img" class="img-fluid">
                        </div>
                        <div class="flex-grow-1 ms-3">
                          <div class="d-flex align-items-center justify-content-center gap-2 text-success">
                            <i class="ti ti-circle f-10"></i>
          ...
          <div class="card">
            <div class="card-body">
              ...
              <div class="d-flex align-items-center justify-content-between gap-2 my-3">
                ...
                <a href="#" class="avtar"><img class="rounded-circle img-fluid" src="<?= base_url('assets/images/user/avatar-1.jpg') ?>" alt="User image"/></a>
                <a href="#" class="avtar"><img class="rounded-circle img-fluid" src="<?= base_url('assets/images/user/avatar-2.jpg') ?>" alt="User image"/></a>
                <a href="#" class="avtar"><img class="rounded-circle img-fluid" src="<?= base_url('assets/images/user/avatar-3.jpg') ?>" alt="User image"/></a>
                <a href="#" class="avtar"><img class="rounded-circle img-fluid" src="<?= base_url('assets/images/user/avatar-4.jpg') ?>" alt="User image"/></a>
              </div>
              <ul class="list-group list-group-flush">
                <li class="list-group-item px-0">
                  <div class="d-flex align-items-center">
                    <div class="flex-shrink-0">
                      <img src="<?= base_url('assets/images/widget/img-acitivity-3.svg') ?>" alt="img" class="wid-30 rounded" />
                    </div>
                    <div class="flex-grow-1 ms-3">
                      <div class="row g-1">
                        <div class="col-6">
  ...
  <script src="<?= base_url('assets/js/pages/dashboard-finance.js') ?>"></script>
  <!-- custom widgets js -->
  <script src="<?= base_url('assets/js/widgets/total-line-1-chart.js') ?>"></script>
  <script src="<?= base_url('assets/js/widgets/total-line-2-chart.js') ?>"></script>
  <script src="<?= base_url('assets/js/widgets/total-line-3-chart.js') ?>"></script>
  <script src="<?= base_url('assets/js/widgets/cashflow-bar-chart.js') ?>"></script>
  <script src="<?= base_url('assets/js/widgets/category-donut-chart.js') ?>"></script>
