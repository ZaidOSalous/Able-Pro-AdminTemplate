...
<html lang="en">
  ...
  <head>
    ...
    <link rel="stylesheet" href="<?= base_url('assets/css/plugins/star-rating.min.css') ?>">
    <?= $this->include('partials/head-css') ?>
    <style>
      :root {
        --gl-star-empty: url("<?= base_url('assets/images/rating/star-empty.svg') ?>");
        --gl-star-full: url("<?= base_url('assets/images/rating/star-full.svg') ?>");
        --gl-star-size: 35px;
      }
                ...
                <form>
                  ...
                  <div class="mb-3 row ">
                    ...
                    <div class="col-lg-9 col-md-9 col-sm-12">
                      ...
                      <label for="glsr-custom-options" s tyle="pointer-events: none;">Using the "data-options" attribute
                        to
                  ...
                  <div class="mb-3 row align-items-center">
                    ...
                    <div class="col-lg-9 col-md-9 col-sm-12">
                      <button type="button" class="btn btn-primary toggle-star-rating">Toggle Star Rating</button>
  ...
  <!-- tagify -->
  <script src="<?= base_url('assets/js/plugins/star-rating.min.js') ?>"></script>
  <script>
    var destroyed = false;
