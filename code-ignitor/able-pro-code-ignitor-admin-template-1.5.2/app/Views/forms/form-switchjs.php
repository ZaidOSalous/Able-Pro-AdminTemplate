...
<html lang="en">
  ...
  <head>
    ...
    <link rel="stylesheet" href="<?= base_url('assets/css/plugins/bootstrap-switch-button.min.css') ?>">
  ...
  <script src="<?= base_url('assets/js/plugins/bootstrap-switch-button.min.js') ?>"></script>
  <script>
    (function () {
