            ...
            <div class="card">
              ...
              <div class="card-body">
                <form>
                  ...
                  <div class="row mb-2">
                    <label class="col-sm-3 text-sm-end pt-0 col-form-label">Inline</label>
                    <div class="col-sm-9">
                  ...
                  <div class="row mb-0">
                    <label class="col-sm-3 text-sm-end pt-0 col-form-label">Inline Radio Checked State </label>
                    <div class="col-sm-9">
                      <div class="form-check form-check-inline">
