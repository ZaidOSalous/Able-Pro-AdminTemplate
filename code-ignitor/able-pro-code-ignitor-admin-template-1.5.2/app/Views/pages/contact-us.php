...
<html lang="en">
  ...
  <body class="landing-page">
    ...
    <!-- [ Main Content ] start -->
    <section class="contact-hero" style="background-image: url(<?= base_url('assets/images/landing/img-headerbg.jpg') ?>)">
      <!-- [ Nav ] start -->
        ...
        <div class="container">
          <div class="row">
            <div class="col-md-4 wow fadeInUp" data-wow-delay="0.2s">
              <img src="<?= base_url('assets/images/logo-dark.svg') ?>" alt="image" class="img-fluid mb-3" />
              <p class="mb-4"
            ...
            <div class="col-md-8">
              <div class="row">
                ...
                <div class="col-sm-4 wow fadeInUp" data-wow-delay="0.8s">
                  ...
                  <ul class="list-unstyled footer-link">
                    <li><a href="https://phoenixcoded.gitbook.io/able-pro/v/code-ignitor/" target="_blank">Documentation</a></li>
                    <li><a href="https://phoenixcoded.gitbook.io/able-pro/v/code-ignitor/" target="_blank">Feature Request</a></li>
                    <li><a href="https://phoenixcoded.gitbook.io/able-pro/v/code-ignitor/" target="_blank">RoadMap</a></li>
