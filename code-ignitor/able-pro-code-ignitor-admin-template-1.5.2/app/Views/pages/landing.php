...
<html lang="en">
  ...
  <body class="landing-page">
        ...
        <div class="row justify-content-center">
          <div class="col-md-10 text-center">
            ...
            <div class="my-4 my-sm-5 wow fadeInUp" data-wow-delay="0.4s">
              ...
              <a href="dashboard-default" class="btn btn-primary">Live Preview</a>
            </div>
            <div
            ...
            <div class="card">
              <div class="card-body">
                ...
                <a class="btn btn-light-dark mt-2" href="https://ableproadmin.com/tailwind/dashboard/index.html" target="_blank"
                  ><i class="ti ti-external-link"></i> Preview</a
                >
                <a
                  ...
                  title="Click to Download Free Able Pro Admin Template"
          ...
          <div class="col-md-6 col-lg-4">
            <div class="card">
              <div class="card-body">
                ...
                <p class="text-muted">Able Pro Vue with Laravel is a powerful admin dashboard template integrating Vue.js 3, Vuetify, and Laravel 10, enabling developers to build dynamic, high-performance applications efficiently.</p>
    ...
    <!-- [ Top Features ] End -->
    <!-- [ figma Features ] Start -->
    <section>
      <div class="container title">
        <div class="row justify-content-center text-center wow fadeInUp" data-wow-delay="0.2s">
          <div class="col-md-8 col-xl-6">
            <h2 class="mb-3">The Complete Figma Design System to Save Hundreds of Hours</h2>
            <p class="mb-0">
              Optimize your workflow with 100% Auto Layout, variables, smart variants, and WCAG accessibility. Enjoy
              super-smart global
              colors, typography, and effects styles + variables, crafted for seamless design efficiency!
            </p>
          </div>
        </div>
      </div>
      <div class="container title">
        <div class="row justify-content-center text-center m-b-25">
          <div class="col-md-10 col-xl-8">
            <img class="" src="<?= base_url('assets/images/landing/figma-light.png') ?>" width="100%" />
          </div>
        </div>
        <div class="d-flex justify-content-center gap-2">
          <a class="btn btn-primary d-flex align-items-center gap-2"
            href="https://codedthemes.com/item/able-pro-free-figma-ui-kit/" target="_blank">
            <i class="ti ti-download"></i> Free Figma
          </a>
          <a class="btn btn-primary d-flex align-items-center gap-2"
            href="https://codedthemes.com/item/able-pro-figma-ui-kit/" target="_blank">
            <i class="ti ti-shopping-cart"></i> Buy Figma
          </a>
        </div>
      </div>
    </section>
        ...
        <div class="row align-items-center wow fadeInUp" data-wow-delay="0.2s">
          ...
          <div class="col-md-4 text-md-end">
            ...
            <a
              ...
              ><i class="ti ti-brand-github"></i> Free Version</a
            >
          </div>
        </div>
      </div>
      ...
      <div class="container title">
        ...
        >
          <div class="col-md-8 col-xl-6">
            ...
            <!-- prettier-ignore -->
            <p class="mb-0"
              >We take pride in our Dashboard development, which has been consistently rated 4.7/5 by our satisfied customers. It brings us joy to share the positive feedback we have received from our loyal clients.</p
            >
          </div>
        </div>
      </div>
                    ...
                    <div class="card-body">
                      <div class="d-flex">
                        ...
                        <div class="flex-grow-1 ms-3">
                          <p class="mb-1"> “Code quality is amazing. Design is astonishing. very easy to customize .. and any developer can use it with ease.“ </p>
                  ...
                  <div class="card support-card">
                    <div class="card-body">
                      <div class="d-flex">
                        ...
                        <div class="flex-grow-1 ms-3">
                          <p class="mb-1"> “I get all what I need for my project from this template so I can focus to back end side. The template looks fantastic and the support is fast. Thank you.“ </p>
                          <small>menhook - <span class="text-muted">Feature Availability</span></small>
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="card-body">
                    <div class="d-flex">
                      ...
                      <div class="flex-grow-1 ms-3">
                        ...
                        <small>devbardbudist - <span class="text-muted">Customizability</span></small>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div class="card support-card">
                  <div class="card-body">
                    <div class="d-flex">
                      ...
                      <div class="flex-grow-1 ms-3">
                        <p class="mb-1"> “The author is very nice and solved my problem inmediately “ </p>
                ...
                <div class="card support-card">
                  <div class="card-body">
                    <div class="d-flex">
                      ...
                      <div class="flex-grow-1 ms-3">
                        <p class="mb-1"> “I love the looks of Able Pro 7.0. I really like the colors you guys have chosen for this theme. It looks really nice.. 💎“ </p>
                ...
                <div class="card support-card">
                  <div class="card-body">
                    <div class="d-flex">
                      ...
                      <div class="flex-grow-1 ms-3">
                        <p class="mb-1"> “An amazing template, Very good design, good quality code and also very good customer support.“ </p>
