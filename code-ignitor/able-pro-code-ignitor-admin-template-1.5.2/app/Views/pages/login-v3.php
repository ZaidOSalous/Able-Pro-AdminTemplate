            ...
            <div class="card-body">
              ...
              <div class="tab-content">
                  ...
                  <div class="text-center">
                    ...
                    <div class="d-grid my-3">
                      <button type="button" class="btn mt-2 btn-light-primary bg-light text-muted" onClick="change_tab('#auth-2')">
                        <img src="<?= base_url('assets/images/authentication/sms.svg') ?>" alt="img" /> <span> Continue with work email</span>
                      </button>
                      <button type="button" class="btn mt-2 btn-light-primary bg-light text-muted">
                        <img src="<?= base_url('assets/images/authentication/facebook.svg') ?>" alt="img" /> <span> Sign In with Facebook</span>
                      </button>
                      <button type="button" class="btn mt-2 btn-light-primary bg-light text-muted">
                        <img src="<?= base_url('assets/images/authentication/twitter.svg') ?>" alt="img" /> <span> Sign In with Twitter</span>
                      </button>
                      <button type="button" class="btn mt-2 btn-light-primary bg-light text-muted">
                        <img src="<?= base_url('assets/images/authentication/google.svg') ?>" alt="img" /> <span> Sign In with Google</span>
                      </button>
                    </div>
                  </div>
                </div>
                <div class="tab-pane" id="auth-2" role="tabpanel" aria-labelledby="auth-tab-2">
                  ...
                  <div class="mb-3">
                    <label class="form-label">Enter your work email to continue</label>
                  ...
                  <div class="row g-3">
                    ...
                    <div class="col-sm-6">
                      <div class="d-grid">
                        <button class="btn btn-primary" onClick="change_tab('#auth-3')">Continue</button>
                      </div>
                    </div>
                  </div>
                </div>
                <div class="tab-pane" id="auth-3" role="tabpanel" aria-labelledby="auth-tab-3">
                  <div class="text-center">
                    <h3 class="text-center mb-3">What’s your purpose for use Able</h3>
                  ...
                  <div class="row g-3">
                    <div class="col-sm-6">
                      <div class="d-grid">
                        <button class="btn btn-outline-secondary" onClick="change_tab('#auth-2')">Back</button>
                      </div>
                    </div>
                    <div class="col-sm-6">
                      <div class="d-grid">
                        <button class="btn btn-primary" onClick="change_tab('#auth-4')">Continue</button>
                      </div>
                    </div>
                  </div>
                </div>
                <div class="tab-pane" id="auth-4" role="tabpanel" aria-labelledby="auth-tab-4">
                  <div class="text-center">
                    <h3 class="text-center mb-3">Tell us About Yourself</h3>
                    <p class="mb-4">Tell us a bit about yourself</p>
                  </div>
                  <div class="row my-4">
                    <div class="col-sm-6">
                      <div class="mb-3">
                  ...
                  <div class="row g-3">
                    <div class="col-sm-6">
                      <div class="d-grid">
                        <button class="btn btn-outline-secondary" onClick="change_tab('#auth-3')">Back</button>
                      </div>
                    </div>
                    <div class="col-sm-6">
                      <div class="d-grid">
                        <button class="btn btn-primary" onClick="change_tab('#auth-5')">Continue</button>
                      </div>
                    </div>
                  </div>
                </div>
                <div class="tab-pane" id="auth-5" role="tabpanel" aria-labelledby="auth-tab-5">
                  <div class="text-center">
                    <h3 class="text-center mb-3">Please confirm your email id</h3>
                    <p class="mb-4">Lorem Ipsum is simply dummy text of the printing and typesetting industry of Lorem Ipsum.</p>
                  </div>
                  ...
                  <div class="d-grid">
                    <button class="btn btn-primary auth-conf">Continue</button>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel">
              <div class="carousel-inner">
                <div class="carousel-item active">
                  <img src="<?= base_url('assets/images/user/avatar-1.jpg') ?>" alt="user-image" class="user-avtar wid-50 rounded-circle mb-3" />
                ...
                <div class="carousel-item">
                  <img src="<?= base_url('assets/images/user/avatar-2.jpg') ?>" alt="user-image" class="user-avtar wid-50 rounded-circle mb-3" />
                  <h5 class="text-white mb-0">Allie Grater</h5>
                  <p class="text-white text-opacity-50">@alliegrater</p>
                  <div class="star f-20 my-4">
                    <i class="fas fa-star text-warning"></i>
                ...
                <div class="carousel-item">
                  <img src="<?= base_url('assets/images/user/avatar-3.jpg') ?>" alt="user-image" class="user-avtar wid-50 rounded-circle mb-3" />
                  <h5 class="text-white mb-0">Allie Grater</h5>
                  <p class="text-white text-opacity-50">@alliegrater</p>
                  <div class="star f-20 my-4">
                    <i class="fas fa-star text-warning"></i>
                ...
                <div class="carousel-item">
                  <img src="<?= base_url('assets/images/user/avatar-4.jpg') ?>" alt="user-image" class="user-avtar wid-50 rounded-circle mb-3" />
                  <h5 class="text-white mb-0">Allie Grater</h5>
                  <p class="text-white text-opacity-50">@alliegrater</p>
                  <div class="star f-20 my-4">
                    <i class="fas fa-star text-warning"></i>
                ...
                <div class="carousel-item">
                  <img src="<?= base_url('assets/images/user/avatar-5.jpg') ?>" alt="user-image" class="user-avtar wid-50 rounded-circle mb-3" />
                  <h5 class="text-white mb-0">Allie Grater</h5>
                  <p class="text-white text-opacity-50">@alliegrater</p>
                  <div class="star f-20 my-4">
                    <i class="fas fa-star text-warning"></i>
