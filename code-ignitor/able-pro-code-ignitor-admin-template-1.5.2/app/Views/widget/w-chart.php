...
<html lang="en">
  ...
  <script src="<?= base_url('assets/js/widgets/all-earnings-graph.js') ?>"></script>
  <script src="<?= base_url('assets/js/widgets/page-views-graph.js') ?>"></script>
  <script src="<?= base_url('assets/js/widgets/total-task-graph.js') ?>"></script>
  <script src="<?= base_url('assets/js/widgets/download-graph.js') ?>"></script>
  <script src="<?= base_url('assets/js/widgets/customer-rate-graph.js') ?>"></script>
  <script src="<?= base_url('assets/js/widgets/tasks-graph.js') ?>"></script>
  <script src="<?= base_url('assets/js/widgets/income-graph.js') ?>"></script>
  <script src="<?= base_url('assets/js/widgets/total-earning-graph-1.js') ?>"></script>
  <script src="<?= base_url('assets/js/widgets/total-earning-graph-2.js') ?>"></script>
  <script src="<?= base_url('assets/js/widgets/new-orders-graph.js') ?>"></script>
  <script src="<?= base_url('assets/js/widgets/new-users-graph.js') ?>"></script>
  <script src="<?= base_url('assets/js/widgets/visitors-graph.js') ?>"></script>
  <script src="<?= base_url('assets/js/widgets/overview-chart.js') ?>"></script>
  <script src="<?= base_url('assets/js/widgets/overview-product-graph.js') ?>"></script>
  <script src="<?= base_url('assets/js/widgets/total-income-graph.js') ?>"></script>
  <script src="<?= base_url('assets/js/widgets/languages-graph.js') ?>"></script>
  <script src="<?= base_url('assets/js/widgets/monthly-report-graph.js') ?>"></script>
  <script src="<?= base_url('assets/js/widgets/sales-report-chart.js') ?>"></script>
  <script src="<?= base_url('assets/js/widgets/acquisition-chart.js') ?>"></script>
