                          ...
                          <tbody>
                            <tr>
                              <td>
                                <div class="d-flex align-items-center">
                                  <div class="flex-shrink-0">
                                    <img src="<?= base_url('assets/images/application/img-prod-2.jpg') ?>" alt="image"
                            ...
                            <tr>
                              <td>
                                <div class="d-flex align-items-center">
                                  <div class="flex-shrink-0">
                                    <img src="<?= base_url('assets/images/application/img-prod-3.jpg') ?>" alt="image"
                                      class="bg-light wid-50 rounded">
                                  </div>
                                  <div class="flex-grow-1 ms-3">
                                    <h5 class="mb-1">Apple MacBook Pro</h5>
                            ...
                            <tr>
                              <td>
                                <div class="d-flex align-items-center">
                                  <div class="flex-shrink-0">
                                    <img src="<?= base_url('assets/images/application/img-prod-4.jpg') ?>" alt="image"
                                      class="bg-light wid-50 rounded">
                                  </div>
                                  <div class="flex-grow-1 ms-3">
                                    <h5 class="mb-1">Apple MacBook Pro</h5>
                    ...
                    <div class="card-body p-0">
                      <ul class="list-group list-group-flush">
                        <li class="list-group-item">
                          <div class="d-flex align-items-start">
                            <img class="bg-light rounded img-fluid wid-60 flex-shrink-0"
                              src="<?= base_url('assets/images/application/img-prod-2.jpg') ?>" alt="User image">
                        ...
                        <li class="list-group-item">
                          <div class="d-flex align-items-start">
                            <img class="bg-light rounded img-fluid wid-60 flex-shrink-0"
                              src="<?= base_url('assets/images/application/img-prod-3.jpg') ?>" alt="User image">
                            <div class="flex-grow-1 mx-2">
                              <h5 class="mb-1">Canon EOS 1500D 24.1</h5>
                              <p class="text-muted text-sm mb-2">SLR Camera (Black) with EF</p>
                              <h5 class="mb-1"><b>$275</b><span
                        ...
                        <li class="list-group-item">
                          <div class="d-flex align-items-start">
                            <img class="bg-light rounded img-fluid wid-60 flex-shrink-0"
                              src="<?= base_url('assets/images/application/img-prod-4.jpg') ?>" alt="User image">
                            <div class="flex-grow-1 mx-2">
                              <h5 class="mb-1">Canon EOS 1500D 24.1</h5>
                              <p class="text-muted text-sm mb-2">SLR Camera (Black) with EF</p>
                              <h5 class="mb-1"><b>$275</b><span
                          ...
                          <div class="col-md-6">
                            <div class="address-check border rounded">
                              <div class="form-check paycard"
                                style="background-image: url(<?= base_url('assets/images/application/img-pay-card-bg.png') ?>);">
                                ...
                                <label class="form-check-label d-block" for="paycard-check-1">
                                  <span class="card-body p-3 d-block">
                                    <span class="d-flex align-items-start justify-content-between">
                                      <h5>John Smith</h5>
                                      <img src="<?= base_url('assets/images/application/mastercard.png') ?>" alt="images"
                                        class="img-fluid">
                                    </span>
                                ...
                                <label class="form-check-label d-block" for="paycard-check-2">
                                  <span class="card-body p-3 d-block">
                                    <span class="d-flex align-items-start justify-content-between">
                                      ...
                                      <img src="<?= base_url('assets/images/application/visa.png') ?>" alt="images" class="img-fluid">
                                    </span>
                                    <span class="row g-2 align-items-center justify-content-between mt-2 mb-5">
                                      <span class="col-auto">
                                        <h5 class="mb-0">****</h5>
                                ...
                                <label class="form-check-label d-block" for="payopn-check-1">
                                  <span class="card-body p-3 d-block">
                                    ...
                                    <span class="d-flex align-items-center">
                                      ...
                                      <img src="<?= base_url('assets/images/application/card.png') ?>" alt="img" class="img-fluid ms-1">
                                    </span>
                                  </span>
                                </label>
                              </div>
                              ...
                              <div class="form-check">
                                ...
                                <label class="form-check-label d-block" for="payopn-check-2">
                                  <span class="card-body p-3 d-block">
                                    ...
                                    <span class="d-flex align-items-center">
                                      <span class="f-12 badge bg-success me-3">5% OFF</span>
                                      <img src="<?= base_url('assets/images/application/paypal.png') ?>" alt="img"
                      ...
                      <div class="card-body">
                        <div class="row">
                          ...
                          <div class="col-6 text-end">
                            <img src="<?= base_url('assets/images/application/img-coupon.png') ?>" alt="img" class="img-fluid">
                          </div>
                        </div>
                      </div>
                    </div>
              ...
              <div class="card my-2 coupon-card bg-warning small-coupon-card">
                <div class="card-body py-2">
                  <div class="d-flex align-items-center justify-content-between">
                    ...
                    <img src="<?= base_url('assets/images/application/img-coupon-1.png') ?>" alt="img" class="img-fluid">
                  </div>
                </div>
              </div>
            </div>
              ...
              <div class="card my-2 coupon-card bg-success small-coupon-card">
                <div class="card-body py-2">
                  <div class="d-flex align-items-center justify-content-between">
                    ...
                    <img src="<?= base_url('assets/images/application/img-coupon-2.png') ?>" alt="img" class="img-fluid">
                  </div>
                </div>
              </div>
            </div>
