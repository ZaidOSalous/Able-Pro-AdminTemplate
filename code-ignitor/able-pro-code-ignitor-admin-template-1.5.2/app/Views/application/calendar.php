...
<html lang="en">
    ...
    <div class="offcanvas-body">
      <form id="pc-form-event" novalidate>
        ...
        <div class="row justify-content-between">
          <div class="col-auto"><button type="button" class="btn btn-link-danger btn-pc-default ms-auto" data-bs-dismiss="offcanvas"><i
  ...
  <!-- calender js -->
  <script src="<?= base_url('assets/js/plugins/index.global.min.js') ?>"></script>
  <!-- Sweet Alert -->
  <script src="<?= base_url('assets/js/plugins/sweetalert2.all.min.js') ?>"></script>
  <script src="<?= base_url('assets/js/application/calendar.js') ?>"></script>
